...
<body>
    ...
    <div class="content-container">
        ...
        <img src="{{ asset('gambarpulsa5.png') }}" alt="Game" class="game-image">
        <h3 class="genshin-title">XL</h3>
        ...
        <h3 class="title">Beli pulsa reguler,paket data, dan masa aktif XL</h3>
        <h3 class="title2">harga paling murah. Cara beli pulsa dan data XL</h3>
    ...
    <div class="data-container">
        <h4 class="data-title">@include('form_xl') </h4>
    </div> 
