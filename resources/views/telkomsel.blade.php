...
<body>
    ...
    <div class="content-container">
        ...
        <img src="{{ asset('gambarpulsa1.png') }}" alt="Game" class="game-image">
        <h3 class="genshin-title">Telkomsel</h3>
        ...
        <h3 class="title">Beli pulsa reguler,paket data, dan masa aktif Telkomsel</h3>
        <h3 class="title2">harga paling murah. Cara beli pulsa dan data Telkomsel</h3>
        ...
        <h3 class="title11">7. Pembelian masa aktif hanya untuk kartu yang memasuki</h3>
        <h3 class="title12">masa tenggang</h3>
    ...
    <div class="data-container">
        <h4 class="data-title">@include('form_telkomsel') </h4>
    </div> 
