...
<div class="card">
    ...
    <div class="top-up-card">
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="55120" data-item="Roblox 100 Robux Global">
                <h3>Roblox 100 Robux</h3>
                <h1>Global</h1>
                <p>RP 55,120</p>
            </div>
            <div class="genshin-card" data-price="82186" data-item="Roblox 200 Robux Global">
                <h3>Roblox 200 Robux</h3>
                <h1>Global</h1>
                <p>RP 82,186</p>
            </div>
            <div class="genshin-card" data-price="143546" data-item="Roblox 400 Robux Global">
                <h3>Roblox 400 Robux</h3>
                <h1>Global</h1>
                <p>RP 143,546</p>
            </div>
        </div>    
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="148226" data-item="Roblox 800 Robux Global">
                <h3>Roblox 800 Robux</h3>
                <h1>Global</h1>
                <p>RP 148,226</p>
            </div>
            <div class="genshin-card" data-price="250546" data-item="Roblox 1.200 Robux Global">
                <h3>Roblox 1.200 Robux</h3>
                <h1>Global</h1>
                <p>RP 250,546</p>
            </div>
            <div class="genshin-card" data-price="342246" data-item="Roblox 1.700 Robux Global">
                <h3>Roblox 1.700 Robux</h3>
                <h1>Global</h1>
                <p>RP 342,246</p>
            </div>
        </div>    
        <div class="genshin-card-container second-container">
            <div class="genshin-card" data-price="367146" data-item="Roblox 2.000 Robux Global">
                <h3>Roblox 2.000 Robux</h3>
                <h1>Global</h1>
                <p>RP 367,146</p>
            </div>
            <div class="genshin-card" data-price="821626" data-item="Roblox 4.500 Robux Global">
                <h3>Roblox 4.5000 Robux</h3>
                <h1>Global</h1>
                <p>RP 821,626</p>
            </div>
            <div class="genshin-card" data-price="1468506" data-item="Roblox 10.000 Robux Global">
                <h3>Roblox 10.000 Robux</h3>
                <h1>Global</h1>
                <p>RP 1,468,506</p>
            </div>
...
function goToPayment() {
    ...
    window.location.href = "view_pembayaran_Roblox"; // Ganti dengan path halaman Anda yang sebenarnya
}
