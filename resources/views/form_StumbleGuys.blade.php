...
<div class="card">
        ...
        <p class="instruction2">Username Stumble Guys</p>
    </div>
    <div class="top-up-card">
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="11258" data-item="Stumble Guys 250 Gems">
                <h3>Stumble Guys 250</h3>
                <h1>Gems</h1>
                <p>RP 11,258</p>
            </div>
            <div class="genshin-card" data-price="24746" data-item="Stumble Guys 800 Gems">
                <h3>Stumble Guys 800</h3>
                <h1>Gems</h1>
                <p>RP 24,746</p>
            </div>
            <div class="genshin-card" data-price="31956" data-item="Stumble Guys 120 Tokens">
                <h3>Stumble Guys 120</h3>
                <h1>Tokens</h1>
                <p>RP 31,956</p>
            </div>
        </div>
        ...
        <div class="genshin-card-container second-container">
            <div class="genshin-card" data-price="105086" data-item="Stumble Guys 5.000 Gems dan 275 Tokens">
                <h3>Stumble Guys 5.000</h3>
                <h1>Gems dan 275 Tokens</h1>
                <p>RP 105,086</p>
            </div>
            <div class="genshin-card" data-price="259072" data-item="Stumble Guys 1.300 Tokens">
                <h3>Stumble Guys 1.300</h3>
                <h1>Tokens</h1>
                <p>RP 259,072</p>
            </div>
...
function goToPayment() {
    ...
    window.location.href = "view_pembayaran_StumbleGuys"; // Ganti dengan path halaman Anda yang sebenarnya
}
