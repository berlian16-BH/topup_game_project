...
<div class="card">
        ...
        <div style="display: flex; justify-content: center; align-items: center;">
            <input type="text" class="user-id-input" placeholder="Nomor HP" required id="userId">
           
        </div>

        <!-- Instruksi di bawah form -->
        <p class="instruction2">Masukkan Nomor HP</p>
    </div>
    <div class="top-up-card">
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="5126" data-item="Google Play Rp.5.000 INDONESIA REGION">
                <h3>Google Play Rp.</h3>
                <h1>5.000 INDONESIA</h1>
                <h4>REGION</h4>
                <p>RP 5,126</p>
            </div>
            <div class="genshin-card" data-price="10245" data-item="Google Play Rp.10.000 INDONESIA REGION">
                <h3>Google Play Rp.</h3>
                <h1>10.000 INDONESIA</h1>
                <h4>REGION</h4>
                <p>RP 10,245</p>
            </div>
            <div class="genshin-card" data-price="20490" data-item="Google Play Rp.20.000 INDONESIA REGION">
                <h3>Google Play Rp.</h3>
                <h1>20.000 INDONESIA</h1>
                <h4>REGION</h4>
                <p>RP 20,490</p>
            </div>
        </div>    
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="51223" data-item="Google Play Rp.50.000 INDONESIA REGION">
                <h3>Google Play Rp.</h3>
                <h1>50.000 INDONESIA</h1>
                <h4>REGION</h4>
                <p>RP 51,223</p>
            </div>
            <div class="genshin-card" data-price="101945" data-item="Google Play Rp.100.000 INDONESIA REGION">
                <h3>Google Play Rp.</h3>
                <h1>100.000 INDONESIA</h1>
                <h4>REGION</h4>
                <p>RP 101,945</p>
            </div>
            <div class="genshin-card" data-price="152880" data-item="Google Play Rp.150.000 INDONESIA REGION">
                <h3>Google Play Rp.</h3>
                <h1>150.000 INDONESIA</h1>
                <h4>REGION</h4>
                <p>RP 152,880</p>
            </div>
        </div>    
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="303680" data-item="Google Play Rp.300.000 INDONESIA REGION">
                <h3>Google Play Rp.</h3>
                <h1>300.000 INDONESIA</h1>
                <h4>REGION</h4>
                <p>RP 303,680</p>
            </div>
            <div class="genshin-card" data-price="509625" data-item="Google Play Rp.500.000 INDONESIA REGION">
                <h3>Google Play Rp.</h3>
                <h1>500.000 INDONESIA</h1>
                <h4>REGION</h4>
                <p>RP 509,625</p>
            </div>
            <div class="genshin-card" data-price="772200" data-item="Google Play Rp.750.000 INDONESIA REGION">
                <h3>Google Play Rp.</h3>
                <h1>750.000 INDONESIA</h1>
                <h4>REGION</h4>
                <p>RP 772,200</p>
            </div>
        </div>    
        <div class="genshin-card-container second-container">
            <div class="genshin-card" data-price="1029600" data-item="Google Play Rp.1.000.000 INDONESIA REGION">
                <h3>Google Play Rp.</h3>
                <h1>1.000.000 INDONESIA</h1>
                <h4>REGION</h4>
                <p>RP 1,029,600</p>
            </div>
            <div class="genshin-card" data-price="1544400" data-item="Google Play Rp.1.500.000 INDONESIA REGION">
                <h3>Google Play Rp.</h3>
                <h1>1,500.000 INDONESIA</h1>
                <h4>REGION</h4>
                <p>RP 1,544,400</p>
            </div>
        </div>
...
function goToPayment() {
    ...
    window.location.href = "view_pembayaran_GooglePlay"; // Ganti dengan path halaman Anda yang sebenarnya
}
