...
<div class="card">
    ...
    <div class="top-up-card">
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="58437" data-item="Genshin Impact 9Blessing of the Welkin Moon 3x">
                <h3>Genshin Impact</h3>
                <h1>Blessing of the</h1>
                <h4>Welkin Moon</h4>
                <p>RP 58,437</p>
            </div>
            <div class="genshin-card" data-price="116614" data-item="Genshin Impact 9Blessing of the Welkin Moon 3x">
                <h3>Genshin Impact</h3>
                <h1>Blessing of the</h1>
                <h4>Welkin Moon 2x</h4>
                <p>RP 116,614</p>
            </div>
            <div class="genshin-card" data-price="174907" data-item="Genshin Impact Blessing of the Welkin Moon 3x">
                <h3>Genshin Impact</h3>
                <h1>Blessing of the</h1>
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="175745" data-item="Genshin Impact 980+110 Genesis Crystals">
                <h3>Genshin Impact</h3>
                <h1>980+110 Genesis</h1>
                <h4>Crystals</h4>
                <p>RP 175,745</p>
            </div>
            <div class="genshin-card" data-price="230775" data-item="Genshin Impact Blessing of the Welkin Moon 4x">
                <h3>Genshin Impact</h3>
                <h1>Blessing of the</h1>
                <h4>Welkin Moon 4x</h4>
                <p>RP 230,775</p>
            </div>
            <div class="genshin-card" data-price="292082"  data-item="Genshin Impact Blessing of the Welkin Moon 5x">
                <h3>Genshin Impact</h3>
                <h1>Blessing of the</h1>
        ...
        <div class="genshin-card-container second-container">
            <div class="genshin-card" data-price="384417" data-item="Genshin Impact 1980+260 Genesis Crystals">
                <h3>Genshin Impact</h3>
                <h1>1980+260 Genesis</h1>
                <h4>Crystals</h4>
                <p>RP 384,417</p>
            </div>
            <div class="genshin-card" data-price="597395" data-item="Genshin Impact 3280+600 Genesis Crystals ">
                <h3>Genshin Impact</h3>
...
function goToPayment() {
    ...
    window.location.href = "view_pembayaran_Genshin"; // Ganti dengan path halaman Anda yang sebenarnya
}
