...
<body>
    ...
    <div class="content-container">
        ...
        <img src="{{ asset('gambar20.png') }}" alt="Game" class="game-image">
        <h3 class="genshin-title">One Punch Man : The Strongest</h3>
        ...
        <h3 class="title7">Tunggu 1 menit Points akan masuk otomatis ke akun anda</h3>
        <h3 class="title8">
            <span class="marquee">
    ...
    <div class="data-container">
        <h4 class="data-title">@include('form_onepunchman') </h4>
    </div> 
    </div>
