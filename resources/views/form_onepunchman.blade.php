...
<div class="card">
    ...
    <div class="top-up-card">
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="8541" data-item="One PunchMan 6 Kupon">
                <h3>One PunchMan 6</h3>
                <h1>Kupon</h1>
                <p>RP 8,541</p>
            </div>
            <div class="genshin-card" data-price="66435" data-item="One PunchMan 37 Kupon">
                <h3>One PunchMan 37</h3>
                <h1>Kupon</h1>
                <p>RP 66,435</p>
            </div>
            <div class="genshin-card" data-price="86211" data-item="One PunchMan 54 Kupon">
                <h3>One PunchMan 54</h3>
                <h1>Kupon</h1>
                <p>RP 86,211</p> 
            </div>
        </div>
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="144047" data-item="One PunchMan 91 Kupon">
                <h3>One PunchMan 91</h3>
                <h1>Kupon</h1>
                <p>RP 144,047</p>
            </div>
            <div class="genshin-card" data-price="198275" data-item="One PunchMan 109 Kupony">
                <h3>One PunchMan 109</h3>
                <h1>Kupon</h1>
                <p>RP 198,275</p>
            </div>
            <div class="genshin-card" data-price="664350" data-item="One PunchMan 362 Kupon">
                <h3>One PunchMan 362</h3>
                <h1>Kupon</h1>
                <p>RP 664,350</p>
            </div>
        </div>
        ...
        <div class="genshin-card-container second-container">
            <div class="genshin-card" data-price="1653150" data-item="One PunchMan 904 Kupon">
                <h3>One PunchMan 904</h3>
                <h1>Kupon</h1>
                <p>RP 1,653,150</p>
            </div>
...
function goToPayment() {
    ...
    window.location.href = "view_pembayaran_OnePunchMan"; // Ganti dengan path halaman Anda yang sebenarnya
}
