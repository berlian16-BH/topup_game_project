...
<div class="card">
    ...
    <div class="top-up-card">
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="621039" data-item="Rise Of Kingdom 12000 Games Powerd by Google play">
                <h3>Rise Of Kingdom</h3>
                <h1>12000 Games</h1>
                <h4>Powerd by Google play</h4>
                <p>RP 621,039</p>
            </div>
...
function goToPayment() {
    ...
    window.location.href = "view_pembayaran_Rise"; // Ganti dengan path halaman Anda yang sebenarnya
}
