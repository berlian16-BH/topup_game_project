...
<div class="card">
    ...
    <div class="top-up-card">
        ...
        <div class="genshin-card-container">
            ...
            <div class="genshin-card" data-price="47989" data-item="Ace Racer 250 Tokens">
                <h3>Ace Racer 250</h3>
                <h1>Tokens</h1>
                <p>RP 47,989</p>
            </div>
            <div class="genshin-card" data-price="120269" data-item="Ace Racer 680 Tokens">
                <h3>Ace Racer 680</h3>
                <h1>Tokens</h1>
                <p>RP 120,269</p>
            </div>
        ...
        <div class="genshin-card-container second-container">
            <div class="genshin-card" data-price="216677" data-item="Ace Racer 1180 Tokens">
                <h3>Ace Racer 1180</h3>
                <h1>Tokens</h1>
                <p>RP 216,677</p>
            </div>
            <div class="genshin-card" data-price="551936" data-item="Ace Racer 2880 Tokens">
                <h3>Ace Racer 2880</h3>
                <h1>Tokens</h1>
                <p>RP 551,936</p>
            </div>
            <div class="genshin-card" data-price="1082180" data-item="Ace Racer 5880 Tokens">
                <h3>Ace Racer 5880</h3>
                <h1>Tokens</h1>
                <p>RP 1,082,180</p>
            </div>
...
function goToPayment() {
    ...
    window.location.href = "view_pembayaran_AceRacer"; // Ganti dengan path halaman Anda yang sebenarnya
}
