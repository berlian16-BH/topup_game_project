...
<div class="card">
    ...
    <div class="top-up-card">
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="9459" data-item="Voucher Garena 33 Shell">
                <h3>Voucher Garena 33</h3>
                <h1>Shell</h1>
                <p>RP 9,459</p>
            </div>
            <div class="genshin-card" data-price="18918" data-item="Vocher Garena 66 Shell">
                <h3>Vocher Garena 66</h3>
                <h1>Shell</h1>
                <p>RP 18,918</p>
            </div>
            <div class="genshin-card" data-price="76079" data-item="Vocher Garena 165 Shell ">
                <h3>Vocher Garena 165</h3>
                <h1>Shell</h1>
                <p>RP 47,294</p>
            </div>
        </div>    
        <div class="genshin-card-container second-container">
            <div class="genshin-card" data-price="1539341" data-item="Garena 330 Shell">
                <h3>Garena 330 Shell</h3>
                <p>RP 88,863</p>
            </div>
...
function goToPayment() {
    ...
    window.location.href = "view_pembayaran_Garena"; // Ganti dengan path halaman Anda yang sebenarnya
}
