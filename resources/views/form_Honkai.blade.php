...
<div class="card">
        ...
        <p class="instruction2">Masukkan User ID & pilih Server.</p>
    </div>
    <div class="top-up-card">
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="11871" data-item="Honkai Star Rail 60 Oneiric Shard">
                <h3>Honkai Star Rail </h3>
                <h1>60 Oneiric Shard</h1>
                <p>Rp 11,871</p>
            </div>
            <div class="genshin-card" data-price="58583" data-item="Honkai Star Rail 300+30 Oneiric Shard ">
                <h3>Honkai Star Rail </h3>
                <h1>300+30 Oneiric Shard</h1>
                <p>Rp 58,583</p>
            </div>
            <div class="genshin-card" data-price="58583" data-item="Honkai Star Rail Express Supply Pass Welkin Moon 3x">
                <h3>Honkai Star Rail</h3>
                <h1>Express Supply Pass</h1>
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="117141" data-item="Honkai Star Rail Express Supply Pass 2x Crystals">
                <h3>Honkai Star Rail</h3>
                <h1>Express Supply Pass 2x</h1>
                <h4>Crystals</h4>
                <p>Rp 117,141</p>
            </div>
            <div class="genshin-card" data-price="175698" data-item="Honkai Star Rail Express Supply Pass 3x">
                <h3>Honkai Star Rail</h3>
                <h1>Express Supply Pass 3x</h1>
                <p>Rp 175,698</p>
            </div>
            <div class="genshin-card" data-price="176296" data-item="Honkai Star Rail 980+110 Oneiric Shard">
                <h3>Honkai Star Rail</h3>
                <h1>980+110 Oneiric Shard</h1>
                <p>Rp 176,296</p>
            </div>
        </div>

        <div class="genshin-card-container">
            <div class="genshin-card" data-price="234828" data-item="Honkai Star Rail Express Supply Pass 4x">
                <h3>Honkai Star Rail</h3>
                <h1>Express Supply Pass 4x</h1>
                <p>Rp 234,230</p>
            </div>
            <div class="genshin-card" data-price="234828" data-item="Honkai Star Rail 1280+140 Oneiric Shard">
                <h3>Honkai Star Rail</h3>
                <h1>1280+140 Oneiric Shard</h1>
                <p>Rp 234,828</p>
            </div>
            <div class="genshin-card" data-price="292788" data-item="Honkai Star Rail Express Supply Pass 5x">
                <h3>Honkai Star Rail</h3>
                <h1>Express Supply Pass 5x</h1>
                <p>Rp 292,788</p>
            </div>
        </div>

        <div class="genshin-card-container">
            <div class="genshin-card" data-price="363616" data-item="Honkai Star Rail 1960+220 Oneiric Shard">
                <h3>Honkai Star Rail</h3>
                <h1>1960+220 Oneiric Shard</h1>
                <p>Rp 363,616</p>
            </div>
            <div class="genshin-card" data-price="382231" data-item="Honkai Star Rail 1980+260 Oneiric Shard">
                <h3>Honkai Star Rail</h3>
                <h1>1980+260 Oneiric Shard</h1>
                <p>Rp 382,231</p>
            </div>
            <div class="genshin-card" data-price="588191" data-item="Honkai Star Rail 3280+600 Oneiric Shard">
                <h3>Honkai Star Rail</h3>
                <h1>3280+600 Oneiric Shard</h1>
                <p>Rp 588,191</p>
            </div>
           
        </div>
        
        <div class="genshin-card-container second-container" data-item="Honkai Star Rail 6480+1600 Oneiric Shard">
        <div class="genshin-card" data-price="1176706">
                <h3>Honkai Star Rail</h3>
                <h1>6480+1600 Oneiric Shard</h1>
                <p>Rp 1,176,706</p>
            </div>
        </div>
    </div>
...
function goToPayment() {
    ...
    window.location.href = "view_pembayaran_Honkai"; // Ganti dengan path halaman Anda yang sebenarnya
}
