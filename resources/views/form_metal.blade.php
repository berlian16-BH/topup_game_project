...
<div class="card">
    ...
    <div class="top-up-card">
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="13484" data-item="Metal Slug Awakening 60 Ruby">
                <h3>Metal Slug</h3>
                <h1>Awakening 60 Ruby</h1>
                <p>RP 13,484</p>
            </div>
            <div class="genshin-card" data-price="59725" data-item="Metal Slug Awakening 310 Ruby">
                <h3>Metal Slug</h3>
                <h1>Awakening 310 Ruby</h1>
                <p>RP 59,725</p>
            </div>
            <div class="genshin-card" data-price="59725" data-item="Metal Slug Awakening Kartu Bulanan">
                <h3>Metal Slug</h3>
                <h1>Awakening Kartu Bulanan</h1>
                <p>RP 59,725</p>
            </div>
        </div>
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="59725" data-item="Metal Slug Awakening Support Pass">
                <h3>Metal Slug</h3>
                <h1>Awakening Support Pass</h1>
                <p>RP 59,725</p>
            </div>
            <div class="genshin-card" data-price="115159" data-item="Metal Slug Awakening 630 Ruby">
                <h3>Metal Slug</h3>
                <h1>Awakening 630 Ruby</h1>
                <p>RP 115,159</p>
            </div>
            <div class="genshin-card" data-price="115159" data-item="Metal Slug Awakening Kartu Bulanan Premium">
                <h3>Metal Slug</h3>
                <h1>Awakening Kartu Bulanan Premium</h1>
                <p>RP 115,159</p>
            </div>
        </div>

        <div class="genshin-card-container">
            <div class="genshin-card" data-price="115159" data-item="Metal Slug Awakening Support Pass Premiun">
                <h3>Metal Slug</h3>
                <h1>Awakening Support Pass Premiun</h1>
                <p>RP 115,159</p>
            </div>
            <div class="genshin-card" data-price="230293" data-item="Metal Slug Awakening 1.300 Ruby">
                <h3>Metal Slug</h3>
                <h1>Awakening 1.300 Ruby</h1>
                <p>RP 230,293</p>
            </div>
            <div class="genshin-card" data-price="597014" data-item="Metal Slug Awakening 3.200 Ruby">
                <h3>Metal Slug</h3>
                <h1>Awakening 3.200 Ruby</h1>
                <p>RP 597,014</p>
            </div>
        </div>
        
        <div class="genshin-card-container second-container">
            <div class="genshin-card" data-price="1151360" data-item="Metal Slug Awakening 6.500 Ruby">
                <h3>Metal Slug</h3>
                <h1>Awakening 6.500 Ruby</h1>
                <p>RP 1,151,360</p>
            </div>
            <div class="genshin-card" data-price="2302694" data-item="Metal Slug Awakening 131.100 Ruby">
                <h3>Metal Slug</h3>
                <h1>Awakening 131.100 Ruby</h1>
                <p>RP 2,302,694</p>
            </div>
            <div class="genshin-card" data-price="3411386" data-item="Metal Slug Awakening 19.650 Ruby">
                <h3>Metal Slug</h3>
                <h1>Awakening 19.650 Ruby</h1>
                <p>RP 3,411,386</p>
            </div>
...
function goToPayment() {
    ...
    window.location.href = "view_pembayaran_Metal"; // Ganti dengan path halaman Anda yang sebenarnya
}
