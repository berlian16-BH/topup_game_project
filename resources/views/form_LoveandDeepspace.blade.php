...
<div class="card">
        ...
        <div style="display: flex; justify-content: center; align-items: center;">
            <input type="text" class="user-id-input" placeholder="HunterID" required id="userId">
           
        </div>

        <!-- Instruksi di bawah form -->
        <p class="instruction2">Masukan ID Hunter</p>
    </div>
    <div class="top-up-card">
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="17005" data-item="Love and Deepspace 60 Crystals">
                <h3>Love and Deepspace</h3>
                <h1>60 Crystals</h1>
                <p>RP 17,005</p>
            </div>
            <div class="genshin-card" data-price="57680" data-item="Love and Deepspace 300 Crystals + 30 Diamonds">
                <h3>Love and Deepspace</h3>
                <h1>300 Crystals + 30</h1>
                <h4>Diamonds</h4>
                <p>RP 57,680</p>
            </div>
            <div class="genshin-card" data-price="57680" data-item="Love and Deepspace Aurum Pass 30 Hari">
                <h3>Love and Deepspace</h3>
                <h1>Aurum Pass 30 Hari</h1>
                <p>RP 57,680</p>
            </div>
        </div>

        <div class="genshin-card-container">
            <div class="genshin-card" data-price="90640" data-item="Love and Deepspace 450 Crystals + 90 Diamonds">
                <h3>Love and Deepspace</h3>
                <h1>450 Crystals + 90 </h1>
                <h4>Diamonds</h4>
                <p>RP 90,640</p>
            </div>
            <div class="genshin-card" data-price="190550" data-item="Love and Deepspac 980 Crystals + 150 Diaminds">
                <h3>Love and Deepspace</h3>
                <h1>980 Crystals + 150 Diaminds</h1>
                <p>RP 190,550</p>
            </div>
            <div class="genshin-card" data-price="283276" data-item="Love and Deepspace Companionship Pack">
                <h3>Love and Deepspace</h3>
                <h1>Companionship Pack</h1>
                <p>RP 283,276</p>
            </div>
        </div>
        
        <div class="genshin-card-container second-container">
            <div class="genshin-card" data-price="375950" data-item="Love and Deepspace 1.980 Crystals + 360 Diamonds">
                <h3>Love and Deepspace</h3>
                <h1>1.980 Crystals + 360 Diamonds</h1>
                <p>RP 375,950</p>
            </div>
            <div class="genshin-card" data-price="607700" data-item="Love and Deepspace 3.280 Crystals + 720 Diamonds">
                <h3>Love and Deepspace</h3>
                <h1>3.280 Crystals + 720 Diamonds</h1>
                <p>RP 607,700</p>
            </div>
            <div class="genshin-card" data-price="1205100" data-item="Love and Deepspace 6.480 Crystals + 1.600 Diamonds">
                <h3>Love and Deepspace</h3>
                <h1>6.480 Crystals + 1.600 Diamonds</h1>
                <p>RP 1,205,100</p>
            </div>
...
function goToPayment() {
    ...
    window.location.href = "view_pembayaran_LoveandDeepspace"; // Ganti dengan path halaman Anda yang sebenarnya
}
