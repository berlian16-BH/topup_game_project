...
<div class="card">
        ...
        <div style="display: flex; justify-content: center; align-items: center;">
            <input type="text" class="user-id-input" placeholder="Username" required id="userId">
           
        </div>

        <!-- Instruksi di bawah form -->
        <p class="instruction2">Username</p>
    </div>
    <div class="top-up-card">
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="6772" data-item="Zepeto 7 Zems">
                <h3>Zepeto 7 Zems</h3>
                <p>RP 6,772</p>
            </div>
            <div class="genshin-card" data-price="12181" data-item="Zepeto 14 Zems">
                <h3>Zepeto 14 Zems</h3>
                <p>RP 12,181</p>
            </div>
            <div class="genshin-card" data-price="13847" data-item="Zepeto 4.680 Zems">
                <h3>Zepeto 4.680 Zems</h3>
                <p>RP 13,847</p>
            </div>
        </div>

        <div class="genshin-card-container">
            <div class="genshin-card" data-price="47764" data-item="Zepeto 58 Zems">
                <h3>Zepeto 58 Zems</h3>
                <p>RP 47,764</p>
            </div>
            <div class="genshin-card" data-price="92726" data-item="Zepeto 128 Zems">
                <h3>Zepeto 128 Zems</h3>
                <p>RP 92,726</p>
            </div>
            <div class="genshin-card" data-price="131366" data-item="Zepeto 62.800 Zems">
                <h3>Zepeto 62.800 Zems</h3>
                <p>RP 131,366</p>
            </div>
        </div>
        
        <div class="genshin-card-container second-container">
            <div class="genshin-card" data-price="597426" data-item="Zepeto 1.000 Zems">
                <h3>Zepeto 1.000 Zems</h3>
                <p>RP 597,426</p>
            </div>
...
function goToPayment() {
    ...
    window.location.href = "view_pembayaran_zepeto"; // Ganti dengan path halaman Anda yang sebenarnya
}
