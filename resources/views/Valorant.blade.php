...
<body>
    ...
    <div class="content-container">
        ...
        <img src="{{ asset('gambar2.png') }}" alt="Game" class="game-image">
        <h3 class="genshin-title">Valorant</h3>
        ...
        <h3 class="title">Masukkan Roit ID</h3>
    ...
    <div class="data-container">
        <h4 class="data-title">@include('form_valorant') </h4>
    </div> 
    </div>
