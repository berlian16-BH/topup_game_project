...
<div class="card">
        ...
        <div style="display: flex; justify-content: center; align-items: center;">
            <input type="text" class="user-id-input" placeholder="Masukkan Nomor Pelanggan" required id="userId">
           
        </div>

        <!-- Instruksi di bawah form -->
        <p class="instruction2">Masukkan Nomor Pelanggan/Meteran</p>
    </div>
    <div class="top-up-card">
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="20925" data-item="PLN 20.000">
                <h3>PLN 20.000</h3>
                <p>RP 20,925</p>
            </div>
            <div class="genshin-card" data-price="52125" data-item="PLN 50.000">
                <h3>PLN 50.000</h3>
                <p>RP 52,125</p>
            </div>
            <div class="genshin-card" data-price="104151" data-item="PLN 100.000">
                <h3>PLN 100.000</h3>
                <p>RP 104,151</p>
            </div>
        ...
        <div class="genshin-card-container second-container">
            <div class="genshin-card" data-price="208151" data-item="PLN 200.000">
                <h3>PLN 200.000</h3>
                <p>RP 208,151</p>
            </div>
...
function goToPayment() {
    ...
    window.location.href = "view_pembayaran_token"; // Ganti dengan path halaman Anda yang sebenarnya
}
