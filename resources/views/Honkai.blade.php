...
<body>
    ...
    <div class="content-container">
        ...
        <img src="{{ asset('gambar3.png') }}" alt="Game" class="game-image">
        <h3 class="genshin-title">Honkai: Star Rail</h3>
        ...
        <h3 class="title7">Tunggu 1 menit Item akan masuk otomatis ke akun anda</h3>
        <h3 class="title8">
            <span class="marquee">
    ...
    <div class="data-container">
        <h4 class="data-title">@include('form_Honkai') </h4>
    </div> 
