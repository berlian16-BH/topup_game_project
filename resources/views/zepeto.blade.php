...
<body>
    ...
    <div class="content-container">
        ...
        <img src="{{ asset('gambar22.png') }}" alt="Game" class="game-image">
        <h3 class="genshin-title">Zepeto</h3>
        ...
        <h3 class="title">Masukkan Seperti Berikut</h3>
        <h3 class="title3">UID vazzstore07 / nickname Vazz Universe</h3>
        <h3 class="title4">Pilih Nominal Gemz</h3>
        <h3 class="title5">Pilih Metode Pembayaran</h3>
        <h3 class="title6">Tulis Nomor Whataspp yg benar!</h3>
        <h3 class="title7">Klik Beli Sekarang & lakukan Pembayaran</h3>
        <h3 class="title2">Estimasi 1 - 30 Menit.</h3>
        <h3 class="title8">
            <span class="marquee">
    ...
    <div class="data-container">
        <h4 class="data-title">@include('form_zepeto') </h4>
    </div> 
    </div>
