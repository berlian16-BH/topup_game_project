...
<div class="card">
        ...
        <div style="display: flex; justify-content: center; align-items: center;">
            <input type="text" class="user-id-input" placeholder="ID Player" required id="userId">
           
        </div>

        <!-- Instruksi di bawah form -->
        <p class="instruction2">Masukan ID Player.</p>
    </div>
    <div class="top-up-card">
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="6167" data-item="PUBG MOBILE 30 UC">
                <h3>PUBG MOBILE 30 UC</h3>
                <p>RP 6,167</p>
            </div>
            <div class="genshin-card" data-price="12615" data-item="PUBG MOBILE 60 UC">
                <h3>PUBG MOBILE 60 UC</h3>
                <p>RP 12,615</p>
            </div>
            <div class="genshin-card" data-price="12616" data-item="PUBG MOBILE 50 UC">
                <h3>PUBG MOBILE 50 UC</h3>
                <p>RP 12,616</p>
            </div>
        </div>

        <div class="genshin-card-container">
            <div class="genshin-card" data-price="12646" data-item="PUBG MOBILE 35 UC">
                <h3>PUBG MOBILE 35 UC</h3>
                <p>RP 12,646</p>
            </div>
            <div class="genshin-card" data-price="19122" data-item="PUBG MOBILE 70 UC">
                <h3>PUBG MOBILE 70 UC</h3>
                <p>RP 19,122</p>
            </div>
            <div class="genshin-card" data-price="20621" data-item="PUBG MOBILE 73 UC">
                <h3>PUBG MOBILE 73 UC</h3>
                <p>RP 20,621</p>
            </div>
        </div>

        <div class="genshin-card-container">
            <div class="genshin-card" data-price="25281" data-item="PUBG MOBILE 100 UC">
                <h3>PUBG MOBILE 100 UC</h3>
                <p>RP 25,281</p>
            </div>
            <div class="genshin-card" data-price="27820" data-item="PUBG MOBILE 105 UC">
                <h3>PUBG MOBILE 105 UC</h3>
                <p>RP 27,820</p>
            </div>
            <div class="genshin-card" data-price="31219" data-item="PUBG MOBILE 131 UC">
                <h3>PUBG MOBILE 131 UC</h3>
                <p>RP 31,219</p>
            </div>
        </div>

        <div class="genshin-card-container">
            <div class="genshin-card" data-price="31235" data-item="PUBG MOBILE 150 UC">
                <h3>PUBG MOBILE 150 UC</h3>
                <p>RP 31,235</p>
            </div>
            <div class="genshin-card" data-price="32970" data-item="PUBG MOBILE 125 UC">
                <h3>PUBG MOBILE 125 UC</h3>
                <p>RP 32,970</p>
            </div>
            <div class="genshin-card" data-price="44434" data-item="PUBG MOBILE 210 UC">
                <h3>PUBG MOBILE 210 UC</h3>
                <p>RP 44,434</p>
            </div>
        </div>

        <div class="genshin-card-container">
            <div class="genshin-card" data-price="57130" data-item="PUBG MOBILE 250 UC">
                <h3>PUBG MOBILE 250 UC</h3>
                <p>RP 57,130</p>
            </div>
            <div class="genshin-card" data-price="58736" data-item="PUBG MOBILE 263 UC">
                <h3>PUBG MOBILE 263 UC</h3>
                <p>RP 58,736</p>
            </div>
            <div class="genshin-card" data-price="61887" data-item="PUBG MOBILE 325 UC">
                <h3>PUBG MOBILE 325 UC</h3>
                <p>RP 61,887 </p>
            </div>
        </div>

        <div class="genshin-card-container">
            <div class="genshin-card" data-price="63477" data-item="PUBG MOBILE 300 UC">
                <h3>PUBG MOBILE 300 UC</h3>
                <p>RP 63,477</p>
            </div>
            <div class="genshin-card" data-price="71096"data-item="PUBG MOBILE 350 UC">
                <h3>PUBG MOBILE 350 UC</h3>
                <p>RP 71,096</p>
            </div>
            <div class="genshin-card" data-price="79336" data-item="PUBG MOBILE 375 UC">
                <h3>PUBG MOBILE 375 UC</h3>
                <p>RP 79,336</p>
            </div>
        </div>

        <div class="genshin-card-container">
            <div class="genshin-card" data-price="101357"data-item="PUBG MOBILE 500 UC">
                <h3>PUBG MOBILE 500 UC</h3>
                <p>RP 101,357</p>
            </div>
            <div class="genshin-card" data-price="140534"data-item="Pubg Royale Pass">
                <h3>Pubg Royale Pass</h3>
                <p>RP 140,534</p>
            </div>
            <div class="genshin-card" data-price="145460" data-item="PUBG MOBILE 750 UC">
                <h3>PUBG MOBILE 750 UC</h3>
                <p>RP 145,460</p>
            </div>
        </div>

        <div class="genshin-card-container">
            <div class="genshin-card" data-price="180276" data-item="PUBG MOBILE 825 UC">
                <h3>PUBG MOBILE 825 UC</h3>
                <p>RP 180,276</p>
            </div>
            <div class="genshin-card" data-price="204378" data-item="PUBG MOBILE 1000 UC">
                <h3>PUBG MOBILE 1000 UC</h3>
                <p>RP 204378</p>
            </div>
            <div class="genshin-card" data-price="243546" data-item="PUBG MOBILE 1250 UC">
                <h3>PUBG MOBILE 1250 UC</h3>
                <p>RP 243,456</p>
            </div>
        </div>

        <div class="genshin-card-container">
            <div class="genshin-card" data-price="272976" data-item="PUBG MOBILE 1375 UC">
                <h3>PUBG MOBILE 1375 UC</h3>
                <p>RP 272,976</p>
            </div>
            <div class="genshin-card" data-price="289991" data-item="PUBG MOBILE 1500 UC">
                <h3>PUBG MOBILE 1500 UC</h3>
                <p>RP 289,991</p>
            </div>
            <div class="genshin-card" data-price="319300" data-item="PUBG MOBILE 1638 UC">
                <h3>PUBG MOBILE 1638 UC</h3>
                <p>RP 319,300</p>
            </div>
        </div>
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="329626" data-item="PUBG MOBILE 1750 UC">
                <h3>PUBG MOBILE 1750 UC</h3>
                <p>RP 329,626</p>
            </div>
            <div class="genshin-card" data-price="362519" data-item="PUBG MOBILE 2000 UC">
                <h3>PUBG MOBILE 2000 UC</h3>
                <p>RP 362,519</p>
            </div>
            <div class="genshin-card" data-price="379087" data-item="Pubg Eliter Pass Plus">
                <h3>Pubg Eliter Pass Plus</h3>
                <p>RP 379,087</p>
            </div>
        </div>

        <div class="genshin-card-container">
            <div class="genshin-card" data-price="530450" data-item="PUBG MOBILE 2875 UC">
                <h3>PUBG MOBILE 2875 UC</h3>
                <p>RP 530,450</p>
            </div>
            <div class="genshin-card" data-price="566500" data-item="PUBG MOBILE 2993 UC">
                <h3>PUBG MOBILE 2993 UC</h3>
                <p>RP 566,500</p>
            </div>
            <div class="genshin-card" data-price="638626" data-item="PUBG MOBILE 3000 UC">
                <h3>PUBG MOBILE 3000 UC</h3>
                <p>RP 638,626</p>
            </div>
        </div>
        <div class="genshin-card-container">
        <div class="genshin-card" data-price="630380" data-item="PUBG MOBILE 3850 UC">
                <h3>PUBG MOBILE 3850 UC</h3>
                <p>RP 630,380</p>
            </div>
            <div class="genshin-card" data-price="638626" data-item="PUBG MOBILE 3500 UC">
                <h3>PUBG MOBILE 3500 UC</h3>
                <p>RP 638,626</p>
            </div>
            <div class="genshin-card" data-price="679826"data-item="PUBG MOBILE 4000 UC">
                <h3>PUBG MOBILE 4000 UC</h3>
                <p>RP 679,826</p>
            </div>
        </div>

        <div class="genshin-card-container">
        <div class="genshin-card" data-price="449563" data-item="PUBG MOBILE 2163 UC">
                <h3>PUBG MOBILE 2163 UC</h3>
                <p>RP 449,563</p>
            </div>
            <div class="genshin-card" data-price="473826" data-item="PUBG MOBILE 2500 UC">
                <h3>PUBG MOBILE 2500 UC</h3>
                <p>RP 473,826</p>
            </div>
            <div class="genshin-card" data-price="885826" data-item="PUBG MOBILE 5000 UC">
                <h3>PUBG MOBILE 5000 UC</h3>
                <p>RP 885,826</p>
            </div>
        </div>
       
        <div class="genshin-card-container second-container" data-item="PUBG MOBILE 8100 UC">
            <div class="genshin-card" data-price="1253975">
                <h3>PUBG MOBILE 8100 UC</h3>
                <p>RP 1,253,975</p>
            </div>
            <div class="genshin-card" data-price="1339026" data-item="PUBG MOBILE 7000 UC">
                <h3>PUBG MOBILE 7000 UC</h3>
                <p>RP 1,339,026</p>
            </div>
        </div>
    </div>
...
function goToPayment() {
    ...
    window.location.href = "view_pembayaran_PUBG"; // Ganti dengan path halaman Anda yang sebenarnya
}
