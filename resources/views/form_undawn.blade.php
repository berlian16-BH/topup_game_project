...
<div class="card">
    ...
    <div class="top-up-card">
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="13588" data-item="Garena Undawn 80 RC">
                <h3>Garena Undawn 80</h3>
                <h1>RC</h1>
                <p>RP 13,588</p>
            </div>
            <div class="genshin-card" data-price="26094" data-item="Garena Undawn Kartu Mingguan">
                <h3>Garena Undawn Kartu</h3>
                <h1>Mingguan</h1>
                <p>RP 26,094</p>
            </div>
            <div class="genshin-card" data-price="40757" data-item="Garena Undawn 250 RC">
                <h3>Garena Undawn 250</h3>
                <h1>RC</h1>
                <p>RP 40,757</p>
            </div>
        </div>
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="43201" data-item="Garena Undawn Kartu Bulan">
                <h3>Garena Undawn Kartu</h3>
                <h1>Bulan</h1>
                <p>RP 43,201</p>
            </div>
            <div class="genshin-card" data-price="67912" data-item="Garena Undawn 450 RC">
                <h3>Garena Undawn 450</h3>
                <h1>RC</h1>
                <p>RP 67,912</p>
            </div>
            <div class="genshin-card" data-price="86649" data-item="Garena Undawn Growrh Fund">
                <h3>Garena Undawn </h3>
                <h1>Growth Fund</h1>
                <p>RP 86,649</p>
            </div>
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="130096" data-item="Garena Undawn Golry Pass Premium">
                <h3>Garena Undawn</h3>
                <h1>Golry Pass Premium</h1>
                <p>RP 130,096</p>
            </div>
            <div class="genshin-card" data-price="134441" data-item="Garena Undawn 920 RC">
                <h3>Garena Undawn 920</h3>
                <h1>RC</h1>
                <p>RP 134,441</p>
            </div>
            <div class="genshin-card" data-price="268856" data-item="Garena Undawn 1.850 RC">
                <h3>Garena Undawn</h3>
                <h1>1.850 RC</h1>
                <p>RP 268,856</p>
            </div>
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="403271" data-item="Garena Undawn 2.800 RC">
                <h3>Garena Undawn</h3>
                <h1>2.800 RC</h1>
                <p>RP 403,271</p>
            </div>
            <div class="genshin-card" data-price="672101" data-item="Garena Undawn 4.750 RC">
                <h3>Garena Undawn</h3>
                <h1>4.750 RC</h1>
                <p>RP 672,101</p>
            </div>
            <div class="genshin-card" data-price="1344176" data-item="Garena Undawn 9.600 RC">
                <h3>Garena Undawn</h3>
                <h1>9.600 RC</h1>
                <p>RP 1,344,176</p>
            </div>
        ...
        <div class="genshin-card-container second-container">
            <div class="genshin-card" data-price="4480526" data-item="Garena Undawn 33.000 RC">
                <h3>Garena Undawn</h3>
                <h1>33.000 RC</h1>
                <p>RP 4,480,526</p>
            </div>
            <div class="genshin-card" data-price="8961026" data-item="Garena Undawn 66.500 RC">
                <h3>Garena Undawn</h3>
                <h1>66.500 RC</h1>
                <p>RP 8,961,026</p>
            </div>
...
function goToPayment() {
    ...
    window.location.href = "view_pembayaran_Undawn"; // Ganti dengan path halaman Anda yang sebenarnya
}
