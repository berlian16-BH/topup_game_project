    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-md-2 mb-3 card-container">
                <a href="pln" onclick="showLightEffect(event, this)">
                    <div class="custom-card card-4">
                        <div class="blue-overlay"></div>
                        <img src="gambarpln1.png" class="custom-card-img-top" alt="unipin" onclick="showLightEffect(event, this.parentElement)">
                        <div class="custom-card-body">
                        <h5 class="custom-card-title">token Listrik PLN</h5>
                        <h6 class="custom-card-subtitle">PTPLN</h6>
                        </div>
                    </div>
                </a>
            </div>
