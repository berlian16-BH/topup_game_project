...
<div class="card">
    ...
    <div class="top-up-card">
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="11354" data-item="Marvel Super War 55 Star Credit">
                <h3>Marvel Super War 55</h3>
                <h1>Star Credit</h1>
                <p>RP 11,354</p>
            </div>
            <div class="genshin-card" data-price="57925" data-item="Marvel Super War 275 Star Credit">
                <h3>Marvel Super War 275</h3>
                <h1>Star Credit</h1>
                <p>RP 57,925</p>
            </div>
            <div class="genshin-card" data-price="116141" data-item="Marvel Super War 565 Star Credit">
                <h3>Marvel Super War 565</h3>
                <h1>Star Credit</h1>
                <p>RP 116,141</p>
            </div>
        </div>
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="232571" data-item="Marvel Super War 1155 Star Credit">
                <h3>Marvel Super War 1155</h3>
                <h1>Star Credit</h1>
                <p>RP 232,571</p>
            </div>
            <div class="genshin-card" data-price="378109" data-item="Marvel Super War 1765 Star Credit">
                <h3>Marvel Super War 1765</h3>
                <h1>Star Credit</h1>
                <p>RP 378,109</p>
            </div>
            <div class="genshin-card" data-price="581862" data-item="Marvel Super War 2950 Star Credit">
                <h3>Marvel Super War 2950</h3>
                <h1>Star Credit</h1>
                <p>RP 581,862</p>
            </div>
        </div>
        ...
        <div class="genshin-card-container second-container">
            <div class="genshin-card" data-price="1164014" data-item="Marvel Super War 6000 Star Credit">
                <h3>Marvel Super War 6000</h3>
                <h1>Star Credit</h1>
                <p>RP 1,164,014</p>
            </div>
...
function goToPayment() {
    ...
    window.location.href = "view_pembayaran_MARVEL"; // Ganti dengan path halaman Anda yang sebenarnya
}
