...
<div class="card">
    ...
    <div class="top-up-card">
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="6263" data-item="FC Mobile 40 FC Points">
                <h3>FC Mobile 40 FC</h3>
                <h1>Points</h1>
                <p>RP 6,263</p>
            </div>
            <div class="genshin-card" data-price="15414" data-item="FC Mobile 100 FC Points">
                <h3>FC Mobile 100 FC</h3>
                <h1>Points</h1>
                <p>RP 15,414</p>
            </div>
            <div class="genshin-card" data-price="76079" data-item="FC Mobile 520 FC Points">
                <h3>FC Mobile 520 FC</h3>
                <h1>Points</h1>
                <p>RP 76,079</p>
            </div>
        </div>
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="153094" data-item="FC Mobile 1.070 FC Points">
                <h3>FC Mobile 1.070 FC</h3>
                <h1>Points</h1>
                <p>RP 153,094</p>
            </div>
            <div class="genshin-card" data-price="316751" data-item="FC Mobile 2.200 FC Points">
                <h3>FC Mobile 2.200 FC</h3>
                <h1>Points</h1>
                <p>RP 316,751</p>
            </div>
            <div class="genshin-card" data-price="769215" data-item="FC Mobile 5.750 FC Points">
                <h3>FC Mobile 5.750 FC</h3>
                <h1>Points</h1>
                <p>RP 769,215</p>
            </div>
        </div>
        ...
        <div class="genshin-card-container second-container">
            <div class="genshin-card" data-price="1539341" data-item="FC Mobile 12.000 FC Points">
                <h3>FC Mobile 12.000 FC</h3>
                <h1>Points</h1>
                <p>RP 1,539.341</p>
            </div>
...
function goToPayment() {
    ...
    window.location.href = "view_pembayaran_FIFA"; // Ganti dengan path halaman Anda yang sebenarnya
}
