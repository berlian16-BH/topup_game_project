...
<h2>Kalkulator Zodiac</h2>
<p>Kalkulator Zodiac ini berfungsi untuk mengetahui total </p>
<p>maksimal diamond yang kamu butuhkan untuk mendapatkan skin Zodiac.  </p>

<div class="container">
    <h3>Masukan Point Zodiac Anda</h3>

    <div class="form-group">
      <label for="totalPoints">Star Point Anda :</label>
      <input type="number" id="totalPoints" placeholder="50" min="0" required oninput="calculateMagicWheel()">
    </div>
...
<script>
    function calculateMagicWheel() {
      ...
      if (!isNaN(totalPoints)) {
        ...
        if (totalPoints >= 100) {
          maxRequired = 0; // If total points are 100 or more
        } else {
          maxRequired = (100 - totalPoints) * 170; // New calculation
        }
