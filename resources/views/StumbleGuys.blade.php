...
<body>
    ...
    <div class="content-container">
        ...
        <img src="{{ asset('gambar24.png') }}" alt="Game" class="game-image">
        <h3 class="genshin-title">Stumble Guys</h3>
        ...
        <h3 class="title">Masukkan Username</h3>
    ...
    <div class="data-container">
        <h4 class="data-title">@include('form_StumbleGuys') </h4>
    </div> 
    </div>
