...
<body>
    ...
    <div class="content-container">
        ...
        <img src="{{ asset('gambarvoucher6.png') }}" alt="Game" class="game-image">
        <h3 class="genshin-title">POINT BLANK</h3>
        ...
        <h3 class="title">Voucher Point Blank</h3>
        <h3 class="title8">
            <span class="marquee">
    ...
    <div class="data-container">
        <h4 class="data-title">@include('form_POINTBLANK') </h4>
    </div> 
    </div>
