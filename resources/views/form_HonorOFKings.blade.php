...
<div class="card">
        ...
        <p class="instruction2">Estimasi token masuk 1-10 menit max 24 jam</p>
    </div>
    <div class="top-up-card">
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="1568" data-item="Honor Of Kings 8 Tokens">
                <h3>Honor Of Kings 8</h3>
                <h1>Tokens</h1>
                <p>RP 1,568</p>
            </div>
            <div class="genshin-card" data-price="2183" data-item="Honor Of Kings 16 Tokens + Bonus">
                <h3>Honor Of Kings 16</h3>
                <h1>Tokens + Bonus</h1>
                <p>RP 2,183</p>
            </div>
            <div class="genshin-card" data-price="11030" data-item="Honor Of Kings 80 Tokens + Bonus">
                <h3>Honor Of Kings 80</h3>
                <h1>Tokens + Bonus</h1>
                <p>RP 11,030</p>
            </div>
        </div>    
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="11030" data-item="Roblox 800 Robux Global">
                <h3>Honor Of Kings </h3>
                <h1>Weekly Card</h1>
                <p>RP 11,030</p>
            </div>
            <div class="genshin-card" data-price="33086" data-item="Honor Of Kings 240 Tokens + Bonus">
                <h3>Honor Of Kings 240</h3>
                <h1>Tokens + Bonus</h1>
                <p>RP 33,086</p>
            </div>
            <div class="genshin-card" data-price="36229" data-item="Honor Of Kings Weekly Card Plus">
                <h3>Honor Of Kings </h3>
                <h1>Weekly Card Plus</h1>
                <p>RP 36,229</p>
            </div>
        </div>    
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="55126" data-item="Honor Of Kings 400 Tokens + Bonus">
                <h3>Honor Of Kings 400</h3>
                <h1>Tokens + Bonus</h1>
                <p>RP 55,126</p>
            </div>
            <div class="genshin-card" data-price="77166" data-item="Honor Of Kings 560 Tokens + Bonus">
                <h3>Honor Of Kings 560</h3>
                <h1>Tokens + Bonus</h1>
                <p>RP 77,166</p>
            </div>
            <div class="genshin-card" data-price="122457" data-item="Honor Of Kings 800 Tokens + Bonus">
                <h3>Honor Of Kings 800</h3>
                <h1>Tokens + Bonus</h1>
                <p>RP 112,457</p>
            </div>
        </div>    
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="169429" data-item="Honor Of Kings 1.200 Tokens + Bonus">
                <h3>Honor Of Kings 1.200</h3>
                <h1>Tokens + Bonus</h1>
                <p>RP 169,429</p>
            </div>
            <div class="genshin-card" data-price="342881" data-item="Honor Of Kings 240 Tokens + Bonus">
                <h3>Honor Of Kings 240</h3>
                <h1>Tokens + Bonus</h1>
                <p>RP 342,881</p>
            </div>
            <div class="genshin-card" data-price="691,774" data-item="Honor Of Kings 4.000 Tokens + Bonus">
                <h3>Honor Of Kings 4.000</h3>
                <h1>Tokens + Bonus</h1>
                <p>RP 691,774</p>
            </div>
        </div>    
        <div class="genshin-card-container second-container">
            <div class="genshin-card" data-price="1124247" data-item="Honor Of Kings 8.000 Tokens + Bonus">
                <h3>Honor Of Kings 8.000</h3>
                <h1>Tokens + Bonus</h1>
                <p>RP 1,124,247</p>
            </div>
...
function goToPayment() {
    ...
    window.location.href = "view_pembayaran_Honor"; // Ganti dengan path halaman Anda yang sebenarnya
}
