...
<body>
    ...
    <div class="content-container">
        ...
        <img src="{{ asset('gambar27.png') }}" alt="Game" class="game-image">
        <h3 class="genshin-title">Mobile Legends Bang Bang</h3>
        ...
        <h3 class="title">Masukkan User ID & Server</h3>
    ...
    <div class="data-container">
        <h4 class="data-title">@include('form_mobile') </h4>
    </div> 
    </div>
