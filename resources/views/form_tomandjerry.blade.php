...
<div class="card">
    ...
    <div class="top-up-card">
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="13987" data-item="Tom and Jerry : Chase 60 Diamond">
                <h3>Tom and Jerry : Chase</h3>
                <h1>60 Diamond</h1>
                <p>RP 13,987</p>
            </div>
            <div class="genshin-card" data-price="40556" data-item="Tom and Jerry : Chase 180 Diamond">
                <h3>Tom and Jerry : Chase</h3>
                <h1>180 Diamond</h1>
                <p>RP 40,556</p>
            </div>
            <div class="genshin-card" data-price="66553" data-item="Tom and Jerry : Chase 300 Diamond">
                <h3>Tom and Jerry : Chase</h3>
                <h1>300 Diamond</h1>
                <p>RP 66,553</p>
            </div>
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="135883" data-item="Tom and Jerry : Chase 600 Diamond">
                <h3>Tom and Jerry : Chase</h3>
                <h1>600 Diamond</h1>
                <p>RP 135,883</p>
            </div>
            <div class="genshin-card" data-price="224128" data-item="Tom and Jerry : Chase 1200 Diamond">
                <h3>Tom and Jerry : Chase</h3>
                <h1>1200 Diamond</h1>
                <p>RP 224,128</p>
            </div>
            <div class="genshin-card" data-price="419545" data-item="Tom and Jerry : Chase 1800 Diamond">
                <h3>Tom and Jerry : Chase</h3>
                <h1>1800 Diamond</h1>
                <p>RP 419,545</p>
            </div>
        ...
        <div class="genshin-card-container second-container">
            <div class="genshin-card" data-price="692907" data-item="Tom and Jerry : Chase 300 Diamond">
                <h3>Tom and Jerry : Chase</h3>
                <h1>3000 Diamond</h1>
                <p>RP 692,907</p>
            </div>
            <div class="genshin-card" data-price="1356433" data-item="Tom and Jerry : Chase 6000 Diamond">
                <h3>Tom and Jerry : Chase</h3>
                <h1>6000 Diamond</h1>
                <p>RP 1,356,433</p>
            </div>
...
function goToPayment() {
    ...
    window.location.href = "view_pembayaran_TomandJerry"; // Ganti dengan path halaman Anda yang sebenarnya
}
