...
<div class="card">
    ...
    <div class="top-up-card">
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="8261" data-item="Super Sus Weekly Card">
                <h3>Super Sus Weekly</h3>
                <h1>Card</h1>
                <p>RP 8,261</p>
            </div>
            <div class="genshin-card" data-price="8532" data-item="Super Sus 100 Goldes">
                <h3>Super Sus 100</h3>
                <h1>Goldes</h1>
                <p>RP 8,532</p>
            </div>
            <div class="genshin-card" data-price="25441" data-item="Super Sus 310 Golden Star">
                <h3>Super Sus 310 Golden</h3>
                <h1>Star</h1>
                <p>RP 25,441</p>
            </div>
        </div>
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="41655" data-item="Super Sus Super Pass">
                <h3>Super Sus Super Pass</h3>
                <p>RP 41,655</p>
            </div>
            <div class="genshin-card" data-price="41655" data-item="Super Sus 520 Golden Star">
                <h3>Super Sus 520</h3>
                <h1>Golden Star</h1>
                <p>RP 41,655</p>
            </div>
            <div class="genshin-card" data-price="84426" data-item="Super Sus Super Pass Bundle">
                <h3>Super Sus Super Pass</h3>
                <h1>Bundle</h1>
                <p>RP 84,426</p>
            </div>
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="41655" data-item="Super Sus 1.060 Golden Star">
                <h3>Super Sus 1.060</h3>
                <h1>Golden Star</h1>
                <p>RP 41,655</p>
            </div>
            <div class="genshin-card" data-price="110189" data-item="Super Sus Monthly Card">
                <h3>Super Sus Monthly</h3>
                <h1>Card</h1>
                <p>RP 110,189</p>
            </div>
            <div class="genshin-card" data-price="119961" data-item="Super Sus Super VIP Card">
                <h3>Super Sus Super VIP</h3>
                <h1>Card</h1>
                <p>RP 119,961</p>
            </div>
        </div>
        ...
        <div class="genshin-card-container second-container">
            <div class="genshin-card" data-price="175126" data-item="Super Sus 2,180 Golden Star">
                <h3>Super Sus 2,180</h3>
                <h1>Golden Star</h1>
                <p>RP 175,126</p>
            </div>
            <div class="genshin-card" data-price="451196" data-item="Super Sus 5.600 Golden Star">
                <h3>Super Sus 5.600</h3>
                <h1>Golden Star</h1>
                <p>RP 452,196</p>
            </div>
...
function goToPayment() {
    ...
    window.location.href = "view_pembayaran_SuperSus"; // Ganti dengan path halaman Anda yang sebenarnya
}
