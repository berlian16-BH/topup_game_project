...
<body>
    ...
    <div class="content-container">
        ...
        <img src="{{ asset('gambar30.png') }}" alt="Game" class="game-image">
        <h3 class="genshin-title">Topup & Joki Game</h3>
        ...
        <h3 class="title">1. Masukan Data Dengan Benar</h3>
        <h3 class="title2">2. Pilih Game & Jenis layanan</h3>
        <h3 class="title3">3. Pilih Pembayaran</h3>
        <h3 class="title4">4. Masukan Nomor WhatsApp kamu</h3>
        <h3 class="title5">5. Klik Beli Sekarang & lakukan Pembayaran</h3>
        <h3 class="title6">6. Pesanan Akan Segera Di Proses.</h3>
        <h3 class="title12">Wajib Mematikan V2L</h3>
        <h3 class="title7">PRIVASI AMAN</h3>
        <h3 class="title13">PROSES 20-60 Menit Max 24 Jam</h3>
        <h3 class="title9">PENTING!! TOLONG JANGAN BUKA GAME SELAGI</h3>
        <h3 class="title10">PROSES!!</h3>
        <h3 class="title11">Jika List Game Tidak Ada, Kalian bisa request ke team</h3>
        <h3 class="title8">
            <span class="marquee">
    ...
    <div class="data-container">
        <h4 class="data-title">@include('form_TopupJokiGame') </h4>
    </div> 
    </div>
