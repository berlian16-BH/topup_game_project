...
<div class="card">
        ...
        <p class="instruction2">Untuk mengetahui User ID Anda, Silakan Klik menu profile dibagian kiri atas pada menu utama game. Dan user ID akan terlihat dibagian bawah kanan Karakter Game Anda. Silakan masukkan User ID Anda untuk menyelesaikan transaksi. Contoh ID: v2aer.</p>
    </div>
    <div class="top-up-card">
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="11286" data-item="Sausage Man 61 Candies">
                <h3>Sausage Man 61</h3>
                <h1>Candies</h1>
                <p>RP 11,286</p>
            </div>
            <div class="genshin-card" data-price="12164" data-item="Sausage Man 60 Candies">
                <h3>Sausage Man 60</h3>
                <h1>Candies</h1>
                <p>RP 12,164</p>
            </div>
            <div class="genshin-card" data-price="34376" data-item="Sausage Man 186 Candies">
                <h3>Sausage Man 186</h3>
                <h1>Candies</h1>
                <p>RP 34,376</p>
            </div>
        </div>
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="36797" data-item="Sausage Man 180 Candies">
                <h3>Sausage Man 180</h3>
                <h1>Candies</h1>
                <p>RP 36,797</p>
            </div>
            <div class="genshin-card" data-price="57336" data-item="Sausage Man 318 Candies">
                <h3>Sausage Man 318</h3>
                <h1>Candies</h1>
                <p>RP 57,336</p>
            </div>
            <div class="genshin-card" data-price="114930"data-item="Sausage Man 686 Candies">
                <h3>Sausage Man 686</h3>
                <h1>Candies</h1>
                <p>RP 114,930</p>
            </div>
        </div>
        ...
        <div class="genshin-card-container">
        <div class="genshin-card" data-price="123626"data-item="Sausage Man 718 Candies">
                <h3>Sausage Man 718</h3>
                <h1>Candies</h1>
                <p>RP 123,626</p>
            </div>
            <div class="genshin-card" data-price="229991"data-item="Sausage Man 1368 Candies">
                <h3>Sausage Man 1368</h3>
                <h1>Candies</h1>
                <p>RP 229,991</p>
            </div>
            <div class="genshin-card" data-price="343105" data-item="Sausage Man 2218 Candies">
                <h3>Sausage Man 2218</h3>
                <h1>Candies</h1>
                <p>RP 343,105/p>
            </div>
        </div>
        ...
        <div class="genshin-card-container second-container">
            <div class="genshin-card" data-price="537355" data-item="Sausage Man 73548 Candies">
                <h3>Sausage Man 73548</h3>
                <h1>Candies</h1>
                <p>RP 573,355</p>
            </div>
        </div>
...
function goToPayment() {
    ...
    window.location.href = "view_pembayaran_SausageMan"; // Ganti dengan path halaman Anda yang sebenarnya
}
