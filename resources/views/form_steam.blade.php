...
<div class="card">
    ...
    <div class="top-up-card">
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="6224" data-item="Steam Wallet Code Rp 6.000">
                <h3>Steam Wallet Code</h3>
                <h1>Rp 6.000</h1>
                <p>RP 6,224</p>
            </div>
            <div class="genshin-card" data-price="8226" data-item="Steam Wallet Code Rp 8.000">
                <h3>Steam Wallet Code</h3>
                <h1>Rp 8.000</h1>
                <p>RP 8,226</p>
            </div>
            <div class="genshin-card" data-price="11809" data-item="Steam Wallet Code Rp 12.000">
                <h3>Steam Wallet Code</h3>
                <h1>Rp 12.000</h1>
                <p>RP 11,809</p>
            </div>
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="45185" data-item="Steam Wallet Code Rp 45.000">
                <h3>Steam Wallet Code</h3>
                <h1>Rp 45.000</h1>
                <p>RP 45,185</p>
            </div>
            <div class="genshin-card" data-price="60781" data-item="Steam Wallet Code Rp 60.000">
                <h3>Steam Wallet Code</h3>
                <h1>Rp 60.000</h1>
                <p>RP 60,781</p>
            </div>
            <div class="genshin-card" data-price="92560" data-item="Voucher Unipin 50.000">
                <h3>Steam Wallet Code</h3>
                <h1>Rp 90.000</h1>
                <p>RP 92,560</p>
            </div>
        ...
        <div class="genshin-card-container second-container">
            <div class="genshin-card" data-price="123396" data-item="Steam Wallet Code Rp 120.000">
                <h3>Steam Wallet Code</h3>
                <h1>Rp 120.000</h1>
                <p>RP 123,396</p>
            </div>
            <div class="genshin-card" data-price="257031" data-item="Steam Wallet Code Rp 250.000">
                <h3>Steam Wallet Code</h3>
                <h1>Rp 250.000</h1>
                <p>RP 257,031</p>
            </div>
            <div class="genshin-card" data-price="409706" data-item="Steam Wallet Code Rp 400.000">
                <h3>Steam Wallet Code</h3>
                <h1>Rp 400.000</h1>
                <p>RP 409,760</p>
            </div>
...
function goToPayment() {
    ...
    window.location.href = "view_pembayaran_Steam"; // Ganti dengan path halaman Anda yang sebenarnya
}
