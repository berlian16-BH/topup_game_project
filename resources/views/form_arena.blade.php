...
<div class="card">
        ...
        <p class="instruction2">Untuk menemukan User ID Anda, Ketuk ikon pengaturan, scroll ke bawah, temukan bagian "Umum", lalu Klik "Player ID". Contoh: "888347346994333".</p>
    </div>
    <div class="top-up-card">
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="9374" data-item="AOV 40 Vouchers">
                <h3>AOV 40 Vouchers</h3>
                <p>RP 9,374</p>
            </div>
            <div class="genshin-card" data-price="18748" data-item="AOV 90 Vouchers">
                <h3>AOV 90 Vouchers</h3>
                <p>RP 18,748</p>
            </div>
            <div class="genshin-card" data-price="46870" data-item="AOV 230 Vouchers">
                <h3>AOV 230 Vouchers</h3>
                <p>RP 46,870</p>
            </div>
        </div>

        <div class="genshin-card-container">
            <div class="genshin-card" data-price="93740" data-item="AOV 470 Vouchers">
                <h3>AOV 470 Vouchers</h3>
                <p>RP 93,740</p>
            </div>
            <div class="genshin-card" data-price="187481" data-item="AOV 950 Vouchers">
                <h3>AOV 950 Vouchers</h3>
                <p>RP 187,481</p>
            </div>
            <div class="genshin-card" data-price="281221"  data-item="AOV 1430 Vouchers">
                <h3>AOV 1430 Vouchers</h3>
                <p>RP 281,221</p>
            </div>
        </div>
        
        <div class="genshin-card-container second-container">
            <div class="genshin-card" data-price="478538" data-item="AOV 2390 Vouchers">
                <h3>AOV 2390 Vouchers</h3>
                <p>RP 478,538</p>
            </div>
            <div class="genshin-card" data-price="966647" data-item="AOV 4800 Vouchers">
                <h3>AOV 4800 Vouchers</h3>
                <p>RP 966,647</p>
            </div>
...
function goToPayment() {
    ...
    window.location.href = "view_pembayaran_Arena"; // Ganti dengan path halaman Anda yang sebenarnya
}
