...
<div class="card">
        ...
        <p class="instruction2">Untuk menemukan User ID Anda, Ketuk ikon pengaturan, "Player ID". Contoh: 888347346994333</p>
    </div>
    <div class="top-up-card">
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="11093" data-item="Blood Strike 100 Gold">
                <h3>Blood Strike 100 Gold</h3>
                <p>RP 11,093</p>
            </div>
            <div class="genshin-card" data-price="35310" data-item="Blood Strike 3000 Gold">
                <h3>Blood Strike 3000</h3>
                <h1>Gold</h1>
                <p>RP 35,310</p>
            </div>
            <div class="genshin-card" data-price="46376" data-item="Blood Strike-Strike Pass Elite">
                <h3>Blood Strike-Strike</h3>
                <h1>Pass Elite</h1>
                <p>RP 46,376</p> 
            </div>
        </div>
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="58991" data-item="Blood Strike 500 Gold">
                <h3>Blood Strike 500</h3>
                <h1>Gold</h1>
                <p>RP 58,991</p>
            </div>
            <div class="genshin-card" data-price="103026" data-item="Blood Strike-Strike Pass Elite +">
                <h3>Blood Strike-Strike</h3>
                <h1>Pass Elite +</h1>
                <p>RP 103,026</p>
            </div>
            <div class="genshin-card" data-price="118194" data-item="Blood Strike 1.000 Gold">
                <h3>Blood Strike 1.000</h3>
                <h1>Gold</h1>
                <p>RP 118,194</p>
            </div>
        </div>
        ...
        <div class="genshin-card-container second-container">
            <div class="genshin-card" data-price="236597" data-item="Blood Strike 2.000 Gold">
                <h3>Blood Strike 2.000</h3>
                <h1>Gold</h1>
                <p>RP 236,597</p>
            </div>
            <div class="genshin-card" data-price="589676" data-item="Blood Strike 5.000 Gold">
                <h3>Blood Strike 5.000</h3>
                <h1>Gold</h1>
                <p>RP 589,676</p>
            </div>
...
function goToPayment() {
    ...
    window.location.href = "view_pembayaran_BLOODSTRIKE"; // Ganti dengan path halaman Anda yang sebenarnya
}
