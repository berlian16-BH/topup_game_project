...
<div class="card">
    ...
    <div class="top-up-card">
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="9568" data-item="Voucher Unipin 10.000">
                <h3>Voucher Unipin</h3>
                <h1>10.000</h1>
                <p>RP 9,568</p>
            </div>
            <div class="genshin-card" data-price="19224" data-item="Voucher Unipin 20.000">
                <h3>Voucher Unipin</h3>
                <h1>20.000</h1>
                <p>RP 19,224</p>
            </div>
            <div class="genshin-card" data-price="47866" data-item="Voucher Unipin 50.000">
                <h3>Voucher Unipin</h3>
                <h1>50.000</h1>
                <p>RP 47,866</p>
            </div>
        ...
        <div class="genshin-card-container second-container">
            <div class="genshin-card" data-price="95706" data-item="Voucher Unipin 100.000">
                <h3>Voucher Unipin</h3>
                <h1>100.000</h1>
                <p>RP 95,706</p>
            </div>
            <div class="genshin-card" data-price="287659" data-item="Voucher Unipin 300.000">
                <h3>Voucher Unipin</h3>
                <h1>300.000</h1>
                <p>RP 287,659</p>
            </div>
            <div class="genshin-card" data-price="479435" data-item="Voucher Unipin 500.000">
                <h3>Voucher Unipin</h3>
                <h1>500.000</h1>
                <p>RP 479,435</p>
            </div>
...
function goToPayment() {
    ...
    window.location.href = "view_pembayaran_Unipin"; // Ganti dengan path halaman Anda yang sebenarnya
}
