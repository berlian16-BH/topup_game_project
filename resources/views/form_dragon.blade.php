...
<div class="card">
    ...
    <div class="top-up-card">
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="16217" data-item="Dragon Raja 76 Coupons">
                <h3>Dragon Raja 76</h3>
                <h1>Coupons</h1>
                <p>RP 16,217</p>
            </div>
            <div class="genshin-card" data-price="19408" data-item="Dragon Raja 90 Coupons">
                <h3>Dragon Raja 90</h3>
                <h1>Coupons</h1>
                <p>RP 19,408</p>
            </div>
            <div class="genshin-card" data-price="162174" data-item="Dragon Raja 337 Coupons">
                <h3>Dragon Raja 337</h3>
                <h1>Coupons</h1>
                <p>RP 162,174</p>
            </div>
        </div>
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="97304" data-item="Dragon Raja 456 Coupons">
                <h3>Dragon Raja 456</h3>
                <h1>Coupons</h1>
                <p>RP 97,304</p>
            </div>
            <div class="genshin-card" data-price="162174" data-item="Dragon Raja 820 Coupons">
                <h3>Dragon Raja 820</h3>
                <h1>Coupons</h1>
                <p>RP 162,174</p>
            </div>
            <div class="genshin-card" data-price="187460" data-item="Dragon Raja Investment Fund">
                <h3>Dragon Raja</h3>
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="248745" data-item="Dragon Raja Investment Fund II">
                <h3>Dragon Raja</h3>
                <h1>Invertment Fund II</h1>
                <p>RP 248,745</p>
            </div>
            <div class="genshin-card" data-price="289456" data-item="League of Legends Wild Rift 605 Wild Cores">
                <h3>Dragon Raja 1699</h3>
                <h1>Coupons</h1>
                <p>RP 289,456</p>
            </div>
            <div class="genshin-card" data-price="442900" data-item="Dragon Raja 2553 Coupons">
                <h3>Dragon Raja 2553</h3>
                <h1>Coupons</h1>
                <p>RP 442,900</p>
            </div>
        </div>
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="973041" data-item="Dragon Raja 5161 Coupons">
                <h3>Dragon Raja 5161</h3>
                <h1>Coupons</h1>
                <p>RP 973,041</p>
            </div>
            <div class="genshin-card" data-price="1249390" data-item="Dragon Raja 7546 Coupons">
                <h3>Dragon Raja 7546</h3>
                <h1>Coupons</h1>
                <p>RP 1,249,390</p>
            </div>
            <div class="genshin-card" data-price="1621735" data-item="Dragon Raja 9056 Coupons">
                <h3>Dragon Raja 9056</h3>
                <h1>Coupons</h1>
                <p>RP 1,621,735</p>
            </div>
        </div>
        ...
        <div class="genshin-card-container second-container">
            <div class="genshin-card" data-price="767855" data-item="League of Legends Wild Reft 605 Wild Cores">
                <h3>Dragon Raja 15092</h3>
                <h1>Coupons</h1>
                <p>RP 2,497,750</p>
            </div>
...
function goToPayment() {
    ...
    window.location.href = "view_pembayaran_DragonRaja"; // Ganti dengan path halaman Anda yang sebenarnya
}
