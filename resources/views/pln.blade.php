...
<body>
    ...
    <div class="content-container">
        ...
        <img src="{{ asset('gambarpln1.png') }}" alt="Game" class="game-image">
        <h3 class="genshin-title">Token Listrik PLN</h3>
        ...
        <h3 class="title">Beli token Listrik resmi PLN 100% irit harga paling murah.</h3>
        <h3 class="title3">Cara beli token PLN termurah :</h3>
        <h3 class="title4">1. Masukkan No Pelanggan</h3>
        <h3 class="title5">2. Pilih Nominal</h3>
        <h3 class="title6">3. Pilih Pembayaran</h3>
        <h3 class="title7">4. Klik Order Now & lakukan Pembayaran</h3>
        <h3 class="title9">Kode token otomatis masuk muncul di halaman invoice</h3>
        <h3 class="title8">
            <span class="marquee">
    ...
    <div class="data-container">
        <h4 class="data-title">@include('form_pln') </h4>
    </div> 
    </div>
