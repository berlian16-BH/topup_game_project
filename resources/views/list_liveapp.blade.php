        ...
        <div class="row">
            ...
            <a href="halaman3.html">
              <div class="custom-card card-1">
                    <img src="gambarapplive1.png" class="custom-card-img-top" alt="Valorant image" onclick="showLightEffect(this)">
                    <div class="custom-card-body">
                        <h5 class="custom-card-title">LITA</h5>
                        <h6 class="custom-card-subtitle">Battuta Technology</h6>
                    </div>
                </div>
            </a>
            </div>
            <div class="col-md-2 mb-3">
             <a href="halaman3.html">
              <div class="custom-card card-2">
                    <img src="gambarapplive2.png" class="custom-card-img-top" alt="Valorant image" onclick="showLightEffect(this)">
                    <div class="custom-card-body">
                        <h5 class="custom-card-title">Bigo Live</h5>
                        <h6 class="custom-card-subtitle">Bigo TechnologyPte.Ltd</h6>
                    </div>
                </div>
             </a>
            </div>
