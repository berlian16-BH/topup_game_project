...
<body>
    ...
    <div class="content-container">
        ...
        <img src="{{ asset('gambar19.png') }}" alt="Game" class="game-image">
        <h3 class="genshin-title">Eggy Party</h3>
        ...
        <h3 class="title">Top up Eggy Party coins harga paling murah, aman, cepat, dan </h3>
        <h3 class="title3">terpercaya hanya di JSTOREGAME.</h3>
        <h3 class="title4">Cara topup Eggy Partyvia ID termurah cukup dengan memasukkan ID</h3>
        <h3 class="title5">dan lakukan pembayaran, secara otomatis coins masuk ke akun Anda.</h3>
        <h3 class="title6">1. Waktu proses 1 detik (setelah pembayaran diterima)</h3>
        <h3 class="title7">2. Layanan top up open 24 Jam Non Stop</h3>
        <h3 class="title2">3. Bantuan chat WhatsApp open 24 jam</h3>
        <h3 class="title8">
            <span class="marquee">
    ...
    <div class="data-container">
        <h4 class="data-title">@include('form_eggyparty') </h4>
    </div> 
    </div>
