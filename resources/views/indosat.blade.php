...
<body>
    ...
    <div class="content-container">
        ...
        <img src="{{ asset('gambarpulsa2.png') }}" alt="Game" class="game-image">
        <h3 class="genshin-title">Indosat</h3>
        ...
        <h3 class="title">Beli pulsa reguler,paket data, dan masa aktif Indosat</h3>
        <h3 class="title2">harga paling murah. Cara beli pulsa dan data Indosat</h3>
    ...
    <div class="data-container">
        <h4 class="data-title">@include('form_indosat') </h4>
    </div> 
