...
<body>
    ...
    <div class="content-container">
        ...
        <img src="{{ asset('gambar4.png') }}" alt="Game" class="game-image">
        <h3 class="genshin-title">PUBG Mobile</h3>
        ...
        <h3 class="title">Open 24 JAM - Proses 1-30 Menit</h3>
        <h3 class="title5">Note UC Indo : Hanya Khusus Untuk Akun PUBG Indonesia.</h3>

        <h3 class="title7">Mohon Perhatikan Negara Pada Akun Anda Sebelum Membeli.</h3>
        <h3 class="title8">
            <span class="marquee">
    ...
    <div class="data-container">
        <h4 class="data-title">@include('form_Pubg') </h4>
    </div> 
