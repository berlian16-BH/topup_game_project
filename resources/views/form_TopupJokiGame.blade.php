...
<head>
    ...
    <style>
      ...
      /* Container untuk top-up yang dapat discroll */
.top-up-container {
    display: flex;
    overflow-x: auto; /* Aktifkan scroll horizontal */
    padding: 10px; /* Berikan padding agar konten tidak terlalu mepet */
    gap: 10px; /* Berikan jarak antar elemen */
    white-space: nowrap; /* Mencegah elemen turun ke baris berikutnya */
    scroll-behavior: smooth; /* Scroll halus saat digeser */
}

/* Kustomisasi scrollbar agar lebih menarik */
.top-up-container::-webkit-scrollbar {
    height: 8px; /* Tinggi scrollbar horizontal */
}

.top-up-container::-webkit-scrollbar-thumb {
    background-color: rgba(0, 0, 0, 0.5); /* Warna scroll bar */
    border-radius: 10px; /* Membuat ujung scroll bar membulat */
}

.top-up-container::-webkit-scrollbar-thumb:hover {
    background-color: rgba(0, 0, 0, 0.8); /* Warna scrollbar saat di-hover */
}

.top-up-container::-webkit-scrollbar-track {
    background-color: transparent; /* Membuat latar belakang track scrollbar transparan */
}
...
.top-up-white-card {
    ...
    font-size: 10px;
    cursor: pointer;
    width: auto; /* Membuat lebar mengikuti panjang konten */
    flex: 0 1 auto; /* Atur agar ukuran card fleksibel mengikuti konten */
    white-space: nowrap; /* Mencegah teks meluas ke baris baru */
}
...
<h1>
    ...
    <div class="top-up-card">
        ...
        <div class="underline"></div> 
         ...
         <div class="top-up-container">
            ...
            <div class="top-up-white-card" id="perpanjangBtn">
                <p>Bike Clash PVP Cycle :T-BULLSA</p>
            </div>
            <div class="top-up-white-card" id="stickmanBtn">
                <p>Stickman Archer PVP</p>
            </div>
            <div class="top-up-white-card" id="deadBtn">
                <p>Dead Target : VNGGane Studios</p>
            </div>
            <div class="top-up-white-card" id="sniperBtn">
                <p>Sniper Zombies :VNGGame Studios</p>
            </div>
            <div class="top-up-white-card" id="zombieBtn">
                <p>Zombie Hunter :VNGGame Studios</p>
            </div>
        </div>
        ...
        <div id="perpanjangCards" class="genshin-card-container" style="display: none;">
            <div class="genshin-card" data-price="51500" data-item="500k Diamond +500k Goal">
                <h3>500k Diamond +</h3>
                <h1>500k Goal</h1>
                <p>RP 51,500</p>
            </div>
            <div class="genshin-card" data-price="101970" data-item="99k Gold + 999 Diamond">
                <h3>99k Gold + 999</h3>
                <h1>Diamond</h1>
                <p>RP 101,970</p>
            </div>
        ...
        <div id="stickmanCards" class="genshin-card-container" style="display: none;">
            <div class="genshin-card" data-price="81689" data-item="1M Diamond">
                <h3>1M Diamond</h3>
                <p>RP 81,689</p>
            </div>
        ...
        <div id="deadCards" class="genshin-card-container" style="display: none;">
           
           
        </div> 
        <div id="sniperCards" class="genshin-card-container" style="display: none;">
            <div class="genshin-card" data-price="51500" data-item="Joki 50 Macth Global Outbreak">
                <h3>Joki 50 Macth Global</h3>
                <h1>Outbreak</h1>
                <p>RP 51,500</p>
            </div>
            <div class="genshin-card" data-price="51500" data-item="Joki 50 Match Sniper Arena PVP">
                <h3>Joki 50 Match Sniper</h3>
                <h1>Arena PVP</h1>
                <p>RP 51,500</p>
            </div>
            <div class="genshin-card" data-price="103000" data-item="Joki Region1-12">
                <h3>Joki Region1-12</h3>
                <p>RP 103,000</p>
            </div>
            <div class="genshin-card" data-price="154500" data-item="1M Gold + Cash + Medal">
                <h3>1M Gold+Cash+</h3>
                <h1>Medal</h1>
                <p>RP 154,500</p>
            </div>
            <div class="genshin-card" data-price="309000" data-item="All Create 499+">
                <h3>All Create 499+</h3>
                <p>RP 309,000</p>
            </div>
            <div class="genshin-card" data-price="819545" data-item="Joki Top 10 World Rank Sniper Arena PVP (Max3day) ">
                <h3>Joki Top 10 World</h3>
                <h1>Rank Sniper Arena</h1>
                <h4>PVP (Max3day)</h4>
                <p>RP 819,545</p>
            </div>
        </div> 
        <div id="zombieCards" class="genshin-card-container" style="display: none;">
            <div class="genshin-card" data-price="101970" data-item="Back To Server Normal (NO Cheater Server)">
                <h3>Back To Server</h3>
                <h1>Normal (NO Cheater Server)</h1>
                <p>RP 101,970</p>
            </div>
            <div class="genshin-card" data-price="103000" data-item="Event Battle Pass + Pass Raid Boss">
                <h3>Event Battle Pass+</h3>
                <h1>Pass Raid Boss</h1>
                <p>RP 103,000</p>
            </div>
            <div class="genshin-card" data-price="127308" data-item="Have All Character + Skin">
                <h3>Have All Character+</h3>
                <h1>Skin</h1>
                <p>RP 127,308</p>
            </div>
            <div class="genshin-card" data-price="132613" data-item="Have All Drone">
                <h3>Have All Drone</h3>
                <p>RP 132,613</p>
            </div>
            <div class="genshin-card" data-price="185658" data-item="Have All Weapon ">
                <h3>Have All Weapon</h3>
                <p>RP 185,658</p>
            </div>
            <div class="genshin-card" data-price="205485" data-item="1M Gold + Cash + Material">
                <h3>1M Gold+Cash+</h3>
                <h1>Material</h1>
                <p>RP 205,485</p>
            </div>
...
function goToPayment() {
    ...
    window.location.href = "view_pembayaran_Topup"; // Ganti dengan path halaman Anda yang sebenarnya
}
...
document.getElementById('topUpBtn').addEventListener('click', () => {
    ...
    document.getElementById('stickmanCards').style.display = 'none';
    document.getElementById('deadCards').style.display = 'none';
    document.getElementById('sniperCards').style.display = 'none';
    document.getElementById('zombieCards').style.display = 'none';
...
document.getElementById('perpanjangBtn').addEventListener('click', () => {
    ...
    document.getElementById('perpanjangCards').style.display = 'grid'; 
    document.getElementById('stickmanCards').style.display = 'none';// Ganti 'flex' dengan 'grid'
    document.getElementById('deadCards').style.display = 'none';
    document.getElementById('sniperCards').style.display = 'none';
    document.getElementById('zombieCards').style.display = 'none';
});
...
document.getElementById('deadBtn').addEventListener('click', () => {
    ...
    document.getElementById('perpanjangCards').style.display = 'none';
    document.getElementById('stickmanCards').style.display = 'none'; // Ganti 'flex' dengan 'grid'
    document.getElementById('deadCards').style.display = 'grid';
    document.getElementById('sniperCards').style.display = 'none';
    document.getElementById('zombieCards').style.display = 'none';
});
...
document.getElementById('sniperBtn').addEventListener('click', () => {
    ...
    document.getElementById('stickmanCards').style.display = 'none'; // Ganti 'flex' dengan 'grid'
    document.getElementById('deadCards').style.display = 'none';
    document.getElementById('sniperCards').style.display = 'grid';
    document.getElementById('zombieCards').style.display = 'none';
});

document.getElementById('zombieBtn').addEventListener('click', () => {
    document.getElementById('topUpCards').style.display = 'none';
    document.getElementById('perpanjangCards').style.display = 'none';
    document.getElementById('stickmanCards').style.display = 'none'; // Ganti 'flex' dengan 'grid'
    document.getElementById('deadCards').style.display = 'none';
    document.getElementById('sniperCards').style.display = 'none';
    document.getElementById('zombieCards').style.display = 'grid';
});

document.getElementById('stickmanBtn').addEventListener('click', () => {
    document.getElementById('topUpCards').style.display = 'none';
    document.getElementById('perpanjangCards').style.display = 'none'; // Ganti 'flex' dengan 'grid'
    document.getElementById('stickmanCards').style.display = 'grid';
    document.getElementById('deadCards').style.display = 'none';
    document.getElementById('sniperCards').style.display = 'none';
    document.getElementById('zombieCards').style.display = 'none';
});
...
document.getElementById('deadBtn').addEventListener('click', () => {
    addBorderEffect('deadBtn');
});

document.getElementById('sniperBtn').addEventListener('click', () => {
    addBorderEffect('sniperBtn');
});
document.getElementById('zombieBtn').addEventListener('click', () => {
    addBorderEffect('zombieBtn');
});

document.getElementById('stickmanBtn').addEventListener('click', () => {
    addBorderEffect('stickmanBtn');
});
