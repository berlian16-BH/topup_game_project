...
<div class="card">
    ...
    <div class="top-up-card">
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="9816" data-item="Lords Mobile 67 Diamonds">
                <h3>Lords Mobile 67</h3>
                <h1>Diamonds</h1>
                <p>RP 9,816</p>
            </div>
            <div class="genshin-card" data-price="19606" data-item="Lords Mobile 134 Diamonds">
                <h3>Lords Mobile 134</h3>
                <h1>Diamonds</h1>
                <p>RP 19,606</p>
            </div>
            <div class="genshin-card" data-price="30591" data-item="Lords Mobile 200 Diamonds">
                <h3>Lords Mobile 200</h3>
                <h1>Diamonds</h1>
                <p>RP 30,591</p>
            </div>
        </div>
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="47895" data-item="Lords Mobile 335 Diamonds">
                <h3>Lords Mobile 335</h3>
                <h1>Diamonds</h1>
                <p>RP 47,895</p>
            </div>
            <div class="genshin-card" data-price="97920" data-item="Lords Mobile 670 Diamonds">
                <h3>Lords Mobile 670</h3>
                <h1>Diamonds</h1>
                <p>RP 97,920</p>
            </div>
            <div class="genshin-card" data-price="293602" data-item="Lords Mobile 2011 Diamonds">
                <h3>Lords Mobile 2011</h3>
                <h1>Diamonds</h1>
                <p>RP 293,602</p>
            </div>
        </div>
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="305910" data-item="Lords Mobile 2090 Diamonds">
                <h3>Lords Mobile 2090</h3>
                <h1>Diamonds</h1>
                <p>RP 305,910</p>
            </div>
            <div class="genshin-card" data-price="489302" data-item="Lords Mobile 3352 Diamonds">
                <h3>Lords Mobile 3352</h3>
                <h1>Diamonds</h1>
                <p>RP 489,302</p>
            </div>
            <div class="genshin-card" data-price="917730" data-item="Lords Mobile 6245 Diamonds">
                <h3>Lords Mobile 6245</h3>
                <h1>Diamonds</h1>
                <p>RP 917,730</p>
            </div>
        </div>
        ...
        <div class="genshin-card-container second-container">
            <div class="genshin-card" data-price="1009709" data-item="Lords Mobile 7365 Diamonds">
                <h3>Lords Mobile 7365</h3>
                <h1>Diamonds</h1>
                <p>RP 1,009,709</p>
            </div>
...
function goToPayment() {
    ...
    window.location.href = "view_pembayaran_Lords"; // Ganti dengan path halaman Anda yang sebenarnya
}
