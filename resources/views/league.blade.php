...
<body>
    ...
    <div class="content-container">
        ...
        <img src="{{ asset('gambar7.png') }}" alt="Game" class="game-image">
        <h3 class="genshin-title">League of Legends</h3>
        ...
        <h3 class="title">Masukkan User ID</h3>
        <h3 class="title2">Pilih Server</h3>
        <h3 class="title3">Pilih Nominal</h3>
        <h3 class="title4">Pilih Pembayaran</h3>
        <h3 class="title5">Masukkan Nomor WhatsApp Kamu</h3>
        <h3 class="title6">Klik Beli Sekarang & lakukan pembayaran</h3>
        <h3 class="title7">Tunggu 1 menit Wild Cores akan masuk otomatis ke akun Anda</h3>
        <h3 class="title8">
            <span class="marquee">
    ...
    <div class="data-container">
        <h4 class="data-title">@include('form_league') </h4>
    </div> 
