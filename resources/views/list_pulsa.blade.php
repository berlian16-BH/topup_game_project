    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-md-2 mb-3 card-container">
                <a href="telkomsel" onclick="showLightEffect(event, this)">
                    <div class="custom-card card-4">
                        <div class="blue-overlay"></div>
                        <img src="gambarpulsa1.png" class="custom-card-img-top" alt="unipin" onclick="showLightEffect(event, this.parentElement)">
            ...
            <!-- Kartu 2 -->
            <div class="col-md-2 mb-3 card-container">
                <a href="indosat" onclick="showLightEffect(event, this)">
                    <div class="custom-card card-4">
                        <div class="blue-overlay"></div>
                        <img src="gambarpulsa2.png" class="custom-card-img-top" alt="unipin" onclick="showLightEffect(event, this.parentElement)">
                        <div class="custom-card-body">
            ...
            <!-- Kartu 3 -->
            <div class="col-md-2 mb-3 card-container">
                <a href="axis" onclick="showLightEffect(event, this)">
                    <div class="custom-card card-4">
                        <div class="blue-overlay"></div>
                        <img src="gambarpulsa3.png" class="custom-card-img-top" alt="unipin" onclick="showLightEffect(event, this.parentElement)">
                        <div class="custom-card-body">
            ...
            <!-- Kartu 4 -->
            <div class="col-md-2 mb-3 card-container">
                <a href="three" onclick="showLightEffect(event, this)">
                    <div class="custom-card card-4">
                        <div class="blue-overlay"></div>
                        <img src="gambarpulsa4.png" class="custom-card-img-top" alt="Google Play Indonesia" onclick="showLightEffect(event, this.parentElement)">
                        <div class="custom-card-body">
            ...
            <!-- Kartu 5 -->
            <div class="col-md-2 mb-3 card-container">
                <a href="Xl" onclick="showLightEffect(event, this)">
                    <div class="custom-card card-4">
                        <div class="blue-overlay"></div>
                        <img src="gambarpulsa5.png" class="custom-card-img-top" alt="Valorant image" onclick="showLightEffect(event, this.parentElement)">
                        <div class="custom-card-body">
            ...
            <!-- Kartu 6 -->
            <div class="col-md-2 mb-3 card-container">
                <a href="byU" onclick="showLightEffect(event, this)">
                    <div class="custom-card card-4">
                        <div class="blue-overlay"></div>
                        <img src="gambarpulsa6.png" class="custom-card-img-top" alt="POINT BLANK" onclick="showLightEffect(event, this.parentElement)">
                        <div class="custom-card-body">
