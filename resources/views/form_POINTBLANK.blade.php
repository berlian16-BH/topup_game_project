...
<div class="card">
        ...
        <div style="display: flex; justify-content: center; align-items: center;">
            <input type="text" class="user-id-input" placeholder="No HP" required id="userId">
           
        </div>

        <!-- Instruksi di bawah form -->
        <p class="instruction2">Masukan No Telepon Dengan Benar</p>
    </div>
    <div class="top-up-card">
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="9240" data-item="Voucher 1.200 PB Cash">
                <h3>Voucher 1.200 PB</h3>
                <h1>Cash</h1>
                <p>RP 9,240</p>
            </div>
            <div class="genshin-card" data-price="18497" data-item="Voucher 2.4000 PB Cash">
                <h3>Voucher 2.400 PB</h3>
                <h1>Cash</h1>
                <p>RP 18,497</p>
            </div>
            <div class="genshin-card" data-price="46244" data-item="Voucher 6.000 PB Cash ">
                <h3>Voucher 6.000 PB</h3>
                <h1>Cash</h1>
                <p>RP 46,244</p>
            </div>
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="93626" data-item="Voucher 12.000 PB Cash">
                <h3>Voucher 12.000 PB</h3>
                <h1>Cash</h1>
                <p>RP 93,626</p>
            </div>
            <div class="genshin-card" data-price="184891" data-item="Voucher 24.000 PB Cash">
                <h3>Voucher 24.000 PB</h3>
                <h1>Cash</h1>
                <p>RP 184,891</p>
            </div>
            <div class="genshin-card" data-price="277326" data-item="Voucher 36.000 PB Cash">
                <h3>Voucher 36.000 PB</h3>
                <h1>Cash</h1>
                <p>RP 277,326</p>
            </div>
        </div>    
        <div class="genshin-card-container second-container">
            <div class="genshin-card" data-price="462197" data-item="Voucher 60.00 PB Cash">
                <h3>Voucher 60.000 PB</h3>
                <h1>Cash</h1>
                <p>RP 462,197</p>
            </div>
...
function goToPayment() {
    ...
    window.location.href = "view_pembayaran_POINT"; // Ganti dengan path halaman Anda yang sebenarnya
}
