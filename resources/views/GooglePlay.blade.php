...
<body>
    ...
    <div class="content-container">
        ...
        <img src="{{ asset('gambarvoucher4.png') }}" alt="Game" class="game-image">
        <h3 class="genshin-title">Google Play Indonesia</h3>
        ...
        <h3 class="title">Beli Voucher Garena Shell harga paling murah</h3>
        <h3 class="title3">1. Pilih Nominal</h3>
        <h3 class="title4">2. Pilih Pembayaran</h3>
        <h3 class="title5">3. Tulis nomor WhatsApp yg benar!</h3>
        <h3 class="title6">Klik Order Now & lakukan Pembayaran</h3>
        <h3 class="title7">4. Kode redeem Voucher otomatis muncul di invoice Anda</h3>
        <h3 class="title9">Masukkan Nomor WhatsApp Dengan Benar!</h3>
        <h3 class="title10">Kesalah Bukan Tanggung Jawab Kami.</h3>
        <h3 class="title8">
            <span class="marquee">
    ...
    <div class="data-container">
        <h4 class="data-title">@include('form_GooglePlay') </h4>
    </div> 
    </div>
