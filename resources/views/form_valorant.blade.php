...
<div class="card">
        ...
        <div style="display: flex; justify-content: center; align-items: center;">
            <input type="text" class="user-id-input" placeholder="Riot ID" required id="userId">
           
        </div>

        <!-- Instruksi di bawah form -->
        <p class="instruction2">Untuk menemukan Riot ID Anda, buka halaman profil akun dan salin Riot ID+Tag menggunakan tombol yang tersedia disamping Riot ID. (Contoh: TopUpKu#123)</p>
    </div>
    <div class="top-up-card">
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="14354" data-item="Valorant124Points">
                <h3>Valorant124Points</h3>
                <p>RP 14,354</p>
            </div>
            <div class="genshin-card" data-price="47873" data-item="Valorant420Points">
                <h3>Valorant420Points</h3>
                <p>RP 47,873</p>
            </div>
            <div class="genshin-card" data-price="174907" data-item="Valorant700Points">
                <h3>Valorant700Points</h3>
                <p>RP 74,557</p>
            </div>
        </div>

        <div class="genshin-card-container">
            <div class="genshin-card" data-price="76794" data-item="Valorant700Point">
                <h3>Valorant700Point</h3>
                <p>RP 76,794</p>
            </div>
            <div class="genshin-card" data-price="127664" data-item="Valorant1125Points">
                <h3>Valorant1125Points</h3>
                <p>RP 127,664</p>
            </div>
            <div class="genshin-card" data-price="139771"  data-item="Valorant1375Points">
                <h3>Valorant1375Points</h3>
                <p>RP 139,771</p>
            </div>
        </div>
        
        <div class="genshin-card-container second-container">
            <div class="genshin-card" data-price="143954" data-item="Valorant1375Point">
                <h3>Valorant1375Point</h3>
                <p>RP 143,954</p>
            </div>
...
function goToPayment() {
    ...
    window.location.href = "view_pembayaran_Valorant"; // Ganti dengan path halaman Anda yang sebenarnya
}
