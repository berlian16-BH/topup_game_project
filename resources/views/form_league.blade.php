...
<div class="card">
    ...
    <div class="top-up-card">
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="30764" data-item="League of Legends Wild Rift 235 wild Cores">
                <h3>League of Legends</h3>
                <h1>Wild Rift 235 wild</h1>
                <h4>Cores</h4>
                <p>RP 30,764</p>
            </div>
            <div class="genshin-card" data-price="76832" data-item="League of Legends Wild Rift 605 Wild Cores">
                <h3>League of Legends</h3>
                <h1>Wild Rift 605 Wild</h1>
                <h4>Cores</h4>
                <p>RP 76,832</p>
            </div>
            <div class="genshin-card" data-price="383953" data-item="League of Legends Wild Rift 3330 Wild Cores">
                <h3>League of Legends</h3>
                <h1>Wild Rift 3330 Wild</h1>
                <h4>Cores</h4>
                <p>RP 383,953</p>
            </div>
        </div>
...
function goToPayment() {
    ...
    window.location.href = "view_pembayaran_League"; // Ganti dengan path halaman Anda yang sebenarnya
}
