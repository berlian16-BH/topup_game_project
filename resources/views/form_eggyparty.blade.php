...
<div class="card">
    ...
    <div class="top-up-card">
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="1673" data-item="Eggy Party 10 Eggy Coins">
                <h3>Eggy Party 10 Eggy</h3>
                <h1>Coins</h1>
                <p>RP 1,673</p>
            </div>
            <div class="genshin-card" data-price="11546" data-item="Eggy Party 60 Eggy Coins + 3 Bonus">
                <h3>Eggy Party 60 Eggy</h3>
                <h1>Coins + 3 Bonus</h1>
                <p>RP 11,546</p>
            </div>
            <div class="genshin-card" data-price="11837" data-item="Eggy Party Eggy Coins Pack">
                <h3>Eggy PartyWeekly</h3>
                <h1>Egg Coins Pack</h1>
                <p>RP 11,837</p>
            </div>
        </div>
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="24056" data-item="Eggy Party 120 Eggy Coins + 6 Bonus">
                <h3>Eggy Party 120 Eggy</h3>
                <h1>Coins + 6 Bonus</h1>
                <p>RP 24,056</p>
            </div>
            <div class="genshin-card" data-price="24781" data-item="Eggy Party Yoyo Membership">
                <h3>Eggy Party Yoyo</h3>
                <h1>Membership</h1>
                <p>RP 24,781</p>
            </div>
            <div class="genshin-card" data-price="35494" data-item="Eggy Party Shiny Coin Jar">
                <h3>Eggy Party Shiny Coin</h3>
                <h1>Jar</h1>
                <p>RP 35,494</p>
            </div>
        </div>
        ...
        <div class="genshin-card-container">
            <div class="genshin-card" data-price="54616" data-item="Eggy Party 300 Eggy Coins + 24 Bonus">
                <h3>Eggy Party 300 Eggy</h3>
                <h1>Coins + 24 Bonus</h1>
                <p>RP 54,616</p>
            </div>
            <div class="genshin-card" data-price="118991" data-item="Eggy Party 700 Eggy Coins + 57 Bonus">
                <h3>Eggy Party 700 Eggy</h3>
                <h1>Coins + 57 Bonus</h1>
                <p>RP 118,991</p>
            </div>
            <div class="genshin-card" data-price="220755" data-item="Eggy Party 1.380 Eggy Coins + 144 Bonus">
                <h3>Eggy Party 1.380 Eggy</h3>
                <h1>Eggy Coins + 144 Bonus</h1>
                <p>RP 220,755</p>
            </div>
        </div>
        
        <div class="genshin-card-container second-container">
            <div class="genshin-card" data-price="397799" data-item="Eggy Party 2.080 Eggy Coins + 216 Bonus">
                <h3>Eggy Party 2.080 Eggy</h3>
                <h1>Coins + 216 Bonus</h1>
                <p>RP 397,799</p>
            </div>
            <div class="genshin-card" data-price="563352" data-item="Eggy Party 3.450 Eggy Coins + 423 Bonus">
                <h3>Eggy Party 3.450 Eggy</h3>
                <h1>Coins + 423 Bonus</h1>
                <p>RP 563,352</p>
            </div>
            <div class="genshin-card" data-price="1089766" data-item="Eggy Party 6.880 Eggy Coins + 930 Bonus">
                <h3>Eggy Party 6.880 Eggy</h3>
                <h1>Coins + 903 Bonus</h1>
                <p>RP 1,089,766</p>
            </div>
...
function goToPayment() {
    ...
    window.location.href = "view_pembayaran_Eggy"; // Ganti dengan path halaman Anda yang sebenarnya
}
