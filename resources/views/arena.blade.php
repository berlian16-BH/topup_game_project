...
<body>
    ...
    <div class="content-container">
        ...
        <img src="{{ asset('gambar9.png') }}" alt="Game" class="game-image">
        <h3 class="genshin-title">Arena of Valor</h3>
        ...
        <h3 class="title7">Tunggu 1 menit Vouchers akan masuk otomatis ke akun Anda.</h3>
        <h3 class="title8">
            <span class="marquee">
    ...
    <div class="data-container">
        <h4 class="data-title">@include('form_arena') </h4>
    </div> 
